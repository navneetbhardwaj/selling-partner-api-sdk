...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForListingsItems.ItemProcurement();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForListingsItems.ItemProcurement.prototype);
  }
});
...
describe('ItemProcurement', () => {
  it('should create an instance of ItemProcurement', () => {
    expect(instance).to.be.a(SellingPartnerApiForListingsItems.ItemProcurement);
  });

  it('should have the property costPrice', () => {
