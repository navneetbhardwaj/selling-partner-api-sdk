...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForListingsItems.Money();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForListingsItems.Money.prototype);
  }
});
...
describe('Money', () => {
  it('should create an instance of Money', () => {
    expect(instance).to.be.a(SellingPartnerApiForListingsItems.Money);
  });
