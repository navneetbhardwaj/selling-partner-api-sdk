...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForEasyShip.ListHandoverSlotsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForEasyShip.ListHandoverSlotsResponse.prototype);
  }
});
...
describe('ListHandoverSlotsResponse', () => {
  it('should create an instance of ListHandoverSlotsResponse', () => {
  ...
  it('should have the property timeSlots', () => {
    // verify property exists
    expect(instance).to.have.property('timeSlots');

    // set and verify value
    const expectedValue = generateMockData('TimeSlot', true);
