...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForEasyShip.RejectedOrder();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForEasyShip.RejectedOrder.prototype);
  }
});
...
describe('RejectedOrder', () => {
  it('should create an instance of RejectedOrder', () => {
  ...
  it('should have the property error', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('Error');
