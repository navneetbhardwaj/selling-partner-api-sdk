...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForEasyShip.Item();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForEasyShip.Item.prototype);
  }
});
...
describe('Item', () => {
  ...
  it('should have the property orderItemSerialNumbers', () => {
    // verify property exists
