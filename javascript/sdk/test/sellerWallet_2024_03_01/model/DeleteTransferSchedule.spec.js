...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForAmazonSellerWalletOpenBankingApi.DeleteTransferSchedule();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForAmazonSellerWalletOpenBankingApi.DeleteTransferSchedule.prototype);
  }
});
...
describe('DeleteTransferSchedule', () => {
  it('should create an instance of DeleteTransferSchedule', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForAmazonSellerWalletOpenBankingApi.DeleteTransferSchedule);
  });
