...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.AppointmentSlot();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.AppointmentSlot.prototype);
  }
});
...
describe('AppointmentSlot', () => {
  ...
  it('should have the property slotId', () => {
  ...
  it('should have the property slotTime', () => {
    // verify property exists
