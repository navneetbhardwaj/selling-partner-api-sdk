...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ListItemComplianceDetailsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ListItemComplianceDetailsResponse.prototype);
  }
});
...
describe('ListItemComplianceDetailsResponse', () => {
  it('should create an instance of ListItemComplianceDetailsResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ListItemComplianceDetailsResponse);
  });

  it('should have the property complianceDetails', () => {
    // verify property exists
    expect(instance).to.have.property('complianceDetails');

    // set and verify value
    const expectedValue = generateMockData('ComplianceDetail', true);
