...
beforeEach(() => {
  try {
    ...
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.TrackingDetails.prototype);
  }
});
...
describe('TrackingDetails', () => {
  ...
  it('should have the property ltlTrackingDetail', () => {
    ...
    const expectedValue = generateMockData('LtlTrackingDetail');
  ...
  it('should have the property spdTrackingDetail', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('SpdTrackingDetail');
