...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.GetSelfShipAppointmentSlotsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.GetSelfShipAppointmentSlotsResponse.prototype);
  }
});
...
describe('GetSelfShipAppointmentSlotsResponse', () => {
  it('should create an instance of GetSelfShipAppointmentSlotsResponse', () => {
  ...
  it('should have the property selfShipAppointmentSlotsAvailability', () => {
    // verify property exists
    expect(instance).to.have.property('selfShipAppointmentSlotsAvailability');

    // set and verify value
    const expectedValue = generateMockData('SelfShipAppointmentSlotsAvailability');
