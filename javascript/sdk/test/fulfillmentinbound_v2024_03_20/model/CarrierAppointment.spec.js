...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.CarrierAppointment();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.CarrierAppointment.prototype);
  }
});
...
describe('CarrierAppointment', () => {
  it('should create an instance of CarrierAppointment', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.CarrierAppointment);
  });
