...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.SpdTrackingDetailInput();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.SpdTrackingDetailInput.prototype);
  }
});
...
describe('SpdTrackingDetailInput', () => {
  it('should create an instance of SpdTrackingDetailInput', () => {
  ...
  it('should have the property spdTrackingItems', () => {
    ...
    const expectedValue = generateMockData('SpdTrackingItemInput', true);
