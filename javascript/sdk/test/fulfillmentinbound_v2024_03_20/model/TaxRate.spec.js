...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.TaxRate();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.TaxRate.prototype);
  }
});
...
describe('TaxRate', () => {
  ...
  it('should have the property cessRate', () => {
  ...
  it('should have the property gstRate', () => {
    // verify property exists
