...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.PackingOptionSummary();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.PackingOptionSummary.prototype);
  }
});
...
describe('PackingOptionSummary', () => {
  it('should create an instance of PackingOptionSummary', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.PackingOptionSummary);
  });
