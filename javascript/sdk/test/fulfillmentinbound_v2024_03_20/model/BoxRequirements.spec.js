...
beforeEach(() => {
  try {
    ...
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.BoxRequirements.prototype);
  }
});
...
describe('BoxRequirements', () => {
  it('should create an instance of BoxRequirements', () => {
  ...
  it('should have the property weight', () => {
    ...
    const expectedValue = generateMockData('WeightRange');
