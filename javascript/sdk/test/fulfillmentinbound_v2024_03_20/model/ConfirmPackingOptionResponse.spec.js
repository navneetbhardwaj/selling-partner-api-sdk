...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ConfirmPackingOptionResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ConfirmPackingOptionResponse.prototype);
  }
});
...
describe('ConfirmPackingOptionResponse', () => {
  it('should create an instance of ConfirmPackingOptionResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ConfirmPackingOptionResponse);
  });
