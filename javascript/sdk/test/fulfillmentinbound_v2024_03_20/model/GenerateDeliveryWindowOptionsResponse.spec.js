...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.GenerateDeliveryWindowOptionsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.GenerateDeliveryWindowOptionsResponse.prototype);
  }
});
...
describe('GenerateDeliveryWindowOptionsResponse', () => {
  it('should create an instance of GenerateDeliveryWindowOptionsResponse', () => {
