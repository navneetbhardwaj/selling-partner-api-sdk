...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ScheduleSelfShipAppointmentResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ScheduleSelfShipAppointmentResponse.prototype);
  }
});
...
describe('ScheduleSelfShipAppointmentResponse', () => {
  it('should create an instance of ScheduleSelfShipAppointmentResponse', () => {
  ...
  it('should have the property selfShipAppointmentDetails', () => {
    ...
    const expectedValue = generateMockData('SelfShipAppointmentDetails');
