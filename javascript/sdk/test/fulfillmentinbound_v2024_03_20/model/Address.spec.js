...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.Address();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.Address.prototype);
  }
});
...
describe('Address', () => {
  it('should create an instance of Address', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.Address);
  });
