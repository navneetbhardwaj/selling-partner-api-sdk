...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.SetPackingInformationRequest();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.SetPackingInformationRequest.prototype);
  }
});
...
describe('SetPackingInformationRequest', () => {
  it('should create an instance of SetPackingInformationRequest', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.SetPackingInformationRequest);
  });

  it('should have the property packageGroupings', () => {
    // verify property exists
    expect(instance).to.have.property('packageGroupings');

    // set and verify value
    const expectedValue = generateMockData('PackageGroupingInput', true);
