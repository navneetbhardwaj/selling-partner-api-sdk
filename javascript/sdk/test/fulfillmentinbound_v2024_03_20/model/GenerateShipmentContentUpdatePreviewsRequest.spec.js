...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.GenerateShipmentContentUpdatePreviewsRequest();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.GenerateShipmentContentUpdatePreviewsRequest.prototype);
  }
});
...
describe('GenerateShipmentContentUpdatePreviewsRequest', () => {
  it('should create an instance of GenerateShipmentContentUpdatePreviewsRequest', () => {
  ...
  it('should have the property boxes', () => {
    ...
    const expectedValue = generateMockData('BoxUpdateInput', true);
