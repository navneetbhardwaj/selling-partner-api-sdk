...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.LtlTrackingDetailInput();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.LtlTrackingDetailInput.prototype);
  }
});
...
describe('LtlTrackingDetailInput', () => {
  it('should create an instance of LtlTrackingDetailInput', () => {
  ...
  it('should have the property freightBillNumber', () => {
    // verify property exists
