...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.Dates();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.Dates.prototype);
  }
});
...
describe('Dates', () => {
  it('should create an instance of Dates', () => {
  ...
  it('should have the property readyToShipWindow', () => {
    ...
    const expectedValue = generateMockData('Window');
