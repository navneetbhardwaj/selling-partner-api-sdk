...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ListShipmentContentUpdatePreviewsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ListShipmentContentUpdatePreviewsResponse.prototype);
  }
});
...
describe('ListShipmentContentUpdatePreviewsResponse', () => {
  it('should create an instance of ListShipmentContentUpdatePreviewsResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ListShipmentContentUpdatePreviewsResponse);
  });

  it('should have the property contentUpdatePreviews', () => {
    // verify property exists
    expect(instance).to.have.property('contentUpdatePreviews');

    // set and verify value
    const expectedValue = generateMockData('ContentUpdatePreview', true);
