...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ListPrepDetailsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ListPrepDetailsResponse.prototype);
  }
});
...
describe('ListPrepDetailsResponse', () => {
  it('should create an instance of ListPrepDetailsResponse', () => {
  ...
  it('should have the property mskuPrepDetails', () => {
    ...
    const expectedValue = generateMockData('MskuPrepDetail', true);
