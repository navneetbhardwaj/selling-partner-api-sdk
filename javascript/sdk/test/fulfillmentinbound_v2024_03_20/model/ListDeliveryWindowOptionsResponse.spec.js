...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ListDeliveryWindowOptionsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ListDeliveryWindowOptionsResponse.prototype);
  }
});
...
describe('ListDeliveryWindowOptionsResponse', () => {
  it('should create an instance of ListDeliveryWindowOptionsResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ListDeliveryWindowOptionsResponse);
  });

  it('should have the property deliveryWindowOptions', () => {
    // verify property exists
    expect(instance).to.have.property('deliveryWindowOptions');

    // set and verify value
    const expectedValue = generateMockData('DeliveryWindowOption', true);
