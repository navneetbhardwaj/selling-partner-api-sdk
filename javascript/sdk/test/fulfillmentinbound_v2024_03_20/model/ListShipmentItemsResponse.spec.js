...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ListShipmentItemsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ListShipmentItemsResponse.prototype);
  }
});
...
describe('ListShipmentItemsResponse', () => {
  it('should create an instance of ListShipmentItemsResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ListShipmentItemsResponse);
  });
