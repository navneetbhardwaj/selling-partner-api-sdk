...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ConfirmTransportationOptionsRequest();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ConfirmTransportationOptionsRequest.prototype);
  }
});
...
describe('ConfirmTransportationOptionsRequest', () => {
  it('should create an instance of ConfirmTransportationOptionsRequest', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ConfirmTransportationOptionsRequest);
  });

  it('should have the property transportationSelections', () => {
    // verify property exists
    expect(instance).to.have.property('transportationSelections');

    // set and verify value
    const expectedValue = generateMockData('TransportationSelection', true);
