...
beforeEach(() => {
  try {
    ...
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ShipmentSource.prototype);
  }
});
...
describe('ShipmentSource', () => {
  it('should create an instance of ShipmentSource', () => {
  ...
  it('should have the property sourceType', () => {
    // verify property exists
