...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ListInboundPlanPalletsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ListInboundPlanPalletsResponse.prototype);
  }
});
...
describe('ListInboundPlanPalletsResponse', () => {
  it('should create an instance of ListInboundPlanPalletsResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ListInboundPlanPalletsResponse);
  });
