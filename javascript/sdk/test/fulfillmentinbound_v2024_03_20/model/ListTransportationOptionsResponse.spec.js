...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ListTransportationOptionsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ListTransportationOptionsResponse.prototype);
  }
});
...
describe('ListTransportationOptionsResponse', () => {
  it('should create an instance of ListTransportationOptionsResponse', () => {
  ...
  it('should have the property transportationOptions', () => {
    // verify property exists
    expect(instance).to.have.property('transportationOptions');

    // set and verify value
    const expectedValue = generateMockData('TransportationOption', true);
