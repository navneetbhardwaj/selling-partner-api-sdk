...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.CreateMarketplaceItemLabelsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.CreateMarketplaceItemLabelsResponse.prototype);
  }
});
...
describe('CreateMarketplaceItemLabelsResponse', () => {
  it('should create an instance of CreateMarketplaceItemLabelsResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.CreateMarketplaceItemLabelsResponse);
  });

  it('should have the property documentDownloads', () => {
    // verify property exists
    expect(instance).to.have.property('documentDownloads');

    // set and verify value
    const expectedValue = generateMockData('DocumentDownload', true);
