...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.GenerateSelfShipAppointmentSlotsRequest();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.GenerateSelfShipAppointmentSlotsRequest.prototype);
  }
});
...
describe('GenerateSelfShipAppointmentSlotsRequest', () => {
  it('should create an instance of GenerateSelfShipAppointmentSlotsRequest', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.GenerateSelfShipAppointmentSlotsRequest);
  });

  it('should have the property desiredEndDate', () => {
  ...
  it('should have the property desiredStartDate', () => {
    // verify property exists
