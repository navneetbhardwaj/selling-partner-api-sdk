...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ShipmentSummary();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ShipmentSummary.prototype);
  }
});
...
describe('ShipmentSummary', () => {
  it('should create an instance of ShipmentSummary', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ShipmentSummary);
  });
