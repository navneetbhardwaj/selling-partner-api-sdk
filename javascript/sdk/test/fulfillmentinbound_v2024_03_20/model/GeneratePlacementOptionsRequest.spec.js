...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.GeneratePlacementOptionsRequest();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.GeneratePlacementOptionsRequest.prototype);
  }
});
...
describe('GeneratePlacementOptionsRequest', () => {
  it('should create an instance of GeneratePlacementOptionsRequest', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.GeneratePlacementOptionsRequest);
  });

  it('should have the property customPlacement', () => {
    // verify property exists
    expect(instance).to.have.property('customPlacement');

    // set and verify value
    const expectedValue = generateMockData('CustomPlacementInput', true);
