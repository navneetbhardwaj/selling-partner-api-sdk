...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.GetDeliveryChallanDocumentResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.GetDeliveryChallanDocumentResponse.prototype);
  }
});
...
describe('GetDeliveryChallanDocumentResponse', () => {
  it('should create an instance of GetDeliveryChallanDocumentResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.GetDeliveryChallanDocumentResponse);
  });

  it('should have the property documentDownload', () => {
    // verify property exists
    expect(instance).to.have.property('documentDownload');

    // set and verify value
    const expectedValue = generateMockData('DocumentDownload');
