...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.Pagination();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.Pagination.prototype);
  }
});
...
describe('Pagination', () => {
  it('should create an instance of Pagination', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.Pagination);
  });
