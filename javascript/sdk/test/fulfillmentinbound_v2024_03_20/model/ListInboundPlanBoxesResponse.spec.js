...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ListInboundPlanBoxesResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ListInboundPlanBoxesResponse.prototype);
  }
});
...
describe('ListInboundPlanBoxesResponse', () => {
  it('should create an instance of ListInboundPlanBoxesResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ListInboundPlanBoxesResponse);
  });
  ...
  it('should have the property boxes', () => {
    ...
    const expectedValue = generateMockData('Box', true);
