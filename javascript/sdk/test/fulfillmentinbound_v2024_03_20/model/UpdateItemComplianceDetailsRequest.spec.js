...
beforeEach(() => {
  try {
    ...
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.UpdateItemComplianceDetailsRequest.prototype);
  }
});
...
describe('UpdateItemComplianceDetailsRequest', () => {
  it('should create an instance of UpdateItemComplianceDetailsRequest', () => {
  ...
  it('should have the property taxDetails', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('TaxDetails');
