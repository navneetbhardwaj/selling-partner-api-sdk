...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.ListInboundPlansResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.ListInboundPlansResponse.prototype);
  }
});
...
describe('ListInboundPlansResponse', () => {
  it('should create an instance of ListInboundPlansResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ListInboundPlansResponse);
  });

  it('should have the property inboundPlans', () => {
    // verify property exists
    expect(instance).to.have.property('inboundPlans');

    // set and verify value
    const expectedValue = generateMockData('InboundPlanSummary', true);
