...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.SetPrepDetailsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.SetPrepDetailsResponse.prototype);
  }
});
...
describe('SetPrepDetailsResponse', () => {
  it('should create an instance of SetPrepDetailsResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.SetPrepDetailsResponse);
  });
