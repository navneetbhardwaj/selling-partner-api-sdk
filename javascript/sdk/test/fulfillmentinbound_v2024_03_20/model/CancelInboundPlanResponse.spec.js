...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFbaInboundOperations.CancelInboundPlanResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFbaInboundOperations.CancelInboundPlanResponse.prototype);
  }
});
...
describe('CancelInboundPlanResponse', () => {
  it('should create an instance of CancelInboundPlanResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFbaInboundOperations.CancelInboundPlanResponse);
  });
