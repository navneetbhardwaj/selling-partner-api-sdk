...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForRetailProcurementOrders.OrderItemStatusReceivingStatus.prototype);
  }
});
...
describe('OrderItemStatusReceivingStatus', () => {
  it('should create an instance of OrderItemStatusReceivingStatus', () => {
    expect(instance).to.be.a(SellingPartnerApiForRetailProcurementOrders.OrderItemStatusReceivingStatus);
  });

  it('should have the property receiveStatus', () => {
    // verify property exists
    expect(instance).to.have.property('receiveStatus');

    // set and verify value
    const expectedValue = ['NOT_RECEIVED', 'PARTIALLY_RECEIVED', 'RECEIVED', ][0];
  ...
  it('should have the property lastReceiveDate', () => {
    // verify property exists
