...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForRetailProcurementOrders.OrderListStatus();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForRetailProcurementOrders.OrderListStatus.prototype);
  }
});
...
describe('OrderListStatus', () => {
  it('should create an instance of OrderListStatus', () => {
  ...
  it('should have the property ordersStatus', () => {
    // verify property exists
    expect(instance).to.have.property('ordersStatus');

    // set and verify value
    const expectedValue = generateMockData('OrderStatus', true);
