...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForRetailProcurementOrders.GetPurchaseOrderResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForRetailProcurementOrders.GetPurchaseOrderResponse.prototype);
  }
});
...
describe('GetPurchaseOrderResponse', () => {
  it('should create an instance of GetPurchaseOrderResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForRetailProcurementOrders.GetPurchaseOrderResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('Order');
