...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForRetailProcurementOrders.GetPurchaseOrdersStatusResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForRetailProcurementOrders.GetPurchaseOrdersStatusResponse.prototype);
  }
});
...
describe('GetPurchaseOrdersStatusResponse', () => {
  it('should create an instance of GetPurchaseOrdersStatusResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('OrderListStatus');
