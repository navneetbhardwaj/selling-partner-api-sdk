...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForRetailProcurementOrders.SubmitAcknowledgementRequest.prototype);
  }
});
...
describe('SubmitAcknowledgementRequest', () => {
  ...
  it('should have the property acknowledgements', () => {
    // verify property exists
    expect(instance).to.have.property('acknowledgements');

    // set and verify value
    const expectedValue = generateMockData('OrderAcknowledgement', true);
