...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForRetailProcurementOrders.PartyIdentification.prototype);
  }
});
...
describe('PartyIdentification', () => {
  ...
  it('should have the property taxInfo', () => {
    // verify property exists
    expect(instance).to.have.property('taxInfo');

    // set and verify value
    const expectedValue = generateMockData('TaxRegistrationDetails');
    instance.taxInfo = expectedValue;
    expect(instance.taxInfo).to.equal(expectedValue);
  });
