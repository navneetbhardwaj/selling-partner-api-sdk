...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForRetailProcurementOrders.GetPurchaseOrdersResponse.prototype);
  }
});
...
describe('GetPurchaseOrdersResponse', () => {
  it('should create an instance of GetPurchaseOrdersResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('OrderList');
