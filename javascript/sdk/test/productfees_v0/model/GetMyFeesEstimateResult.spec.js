...
describe('GetMyFeesEstimateResult', () => {
  it('should create an instance of GetMyFeesEstimateResult', () => {
    expect(instance).to.be.a(SellingPartnerApiForProductFees.GetMyFeesEstimateResult);
  });

  it('should have the property feesEstimateResult', () => {
    // verify property exists
    expect(instance).to.have.property('feesEstimateResult');

    // set and verify value
    const expectedValue = generateMockData('FeesEstimateResult');
