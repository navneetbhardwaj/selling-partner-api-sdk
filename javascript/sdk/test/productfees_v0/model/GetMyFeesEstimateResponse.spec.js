...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForProductFees.GetMyFeesEstimateResponse.prototype);
  }
});
...
describe('GetMyFeesEstimateResponse', () => {
  it('should create an instance of GetMyFeesEstimateResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetMyFeesEstimateResult');
