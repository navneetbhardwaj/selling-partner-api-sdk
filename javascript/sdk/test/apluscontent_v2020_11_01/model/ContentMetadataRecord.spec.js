...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForAContentManagement.ContentMetadataRecord();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForAContentManagement.ContentMetadataRecord.prototype);
  }
});
...
describe('ContentMetadataRecord', () => {
  it('should create an instance of ContentMetadataRecord', () => {
  ...
  it('should have the property contentMetadata', () => {
    // verify property exists
    expect(instance).to.have.property('contentMetadata');

    // set and verify value
    const expectedValue = generateMockData('ContentMetadata');
