...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForAContentManagement.StandardImageTextOverlayModule();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForAContentManagement.StandardImageTextOverlayModule.prototype);
  }
});
...
describe('StandardImageTextOverlayModule', () => {
  it('should create an instance of StandardImageTextOverlayModule', () => {
    expect(instance).to.be.a(SellingPartnerApiForAContentManagement.StandardImageTextOverlayModule);
  });

  it('should have the property overlayColorType', () => {
    // verify property exists
    expect(instance).to.have.property('overlayColorType');

    // set and verify value
    const expectedValue = generateMockData('ColorType');
