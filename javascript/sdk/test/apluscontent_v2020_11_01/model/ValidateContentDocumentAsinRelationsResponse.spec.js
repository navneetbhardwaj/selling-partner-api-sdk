...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForAContentManagement.ValidateContentDocumentAsinRelationsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForAContentManagement.ValidateContentDocumentAsinRelationsResponse.prototype);
  }
});
...
describe('ValidateContentDocumentAsinRelationsResponse', () => {
  it('should create an instance of ValidateContentDocumentAsinRelationsResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForAContentManagement.ValidateContentDocumentAsinRelationsResponse);
  });
