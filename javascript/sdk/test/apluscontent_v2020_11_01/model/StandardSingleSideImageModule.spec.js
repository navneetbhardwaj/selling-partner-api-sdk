...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForAContentManagement.StandardSingleSideImageModule();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForAContentManagement.StandardSingleSideImageModule.prototype);
  }
});
...
describe('StandardSingleSideImageModule', () => {
  it('should create an instance of StandardSingleSideImageModule', () => {
    expect(instance).to.be.a(SellingPartnerApiForAContentManagement.StandardSingleSideImageModule);
  });

  it('should have the property imagePositionType', () => {
    // verify property exists
    expect(instance).to.have.property('imagePositionType');

    // set and verify value
    const expectedValue = generateMockData('PositionType');
