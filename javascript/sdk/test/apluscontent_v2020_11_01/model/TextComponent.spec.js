...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForAContentManagement.TextComponent.prototype);
  }
});
...
describe('TextComponent', () => {
  it('should create an instance of TextComponent', () => {
  ...
  it('should have the property decoratorSet', () => {
    // verify property exists
    expect(instance).to.have.property('decoratorSet');

    // set and verify value
    const expectedValue = generateMockData('Decorator', true);
