...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForAContentManagement.StandardCompanyLogoModule();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForAContentManagement.StandardCompanyLogoModule.prototype);
  }
});
...
describe('StandardCompanyLogoModule', () => {
  it('should create an instance of StandardCompanyLogoModule', () => {
    expect(instance).to.be.a(SellingPartnerApiForAContentManagement.StandardCompanyLogoModule);
  });

  it('should have the property companyLogo', () => {
