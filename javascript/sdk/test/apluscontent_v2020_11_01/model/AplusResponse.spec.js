...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForAContentManagement.AplusResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForAContentManagement.AplusResponse.prototype);
  }
});
...
describe('AplusResponse', () => {
  it('should create an instance of AplusResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForAContentManagement.AplusResponse);
  });
