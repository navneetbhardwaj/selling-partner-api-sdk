...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForAContentManagement.StandardHeaderTextListBlock();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForAContentManagement.StandardHeaderTextListBlock.prototype);
  }
});
...
describe('StandardHeaderTextListBlock', () => {
  it('should create an instance of StandardHeaderTextListBlock', () => {
    expect(instance).to.be.a(SellingPartnerApiForAContentManagement.StandardHeaderTextListBlock);
  });
