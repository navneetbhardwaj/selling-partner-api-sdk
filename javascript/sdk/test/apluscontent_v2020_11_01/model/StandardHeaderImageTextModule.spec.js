...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForAContentManagement.StandardHeaderImageTextModule();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForAContentManagement.StandardHeaderImageTextModule.prototype);
  }
});
...
describe('StandardHeaderImageTextModule', () => {
  it('should create an instance of StandardHeaderImageTextModule', () => {
    expect(instance).to.be.a(SellingPartnerApiForAContentManagement.StandardHeaderImageTextModule);
  });
