...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForAContentManagement.IntegerWithUnits();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForAContentManagement.IntegerWithUnits.prototype);
  }
});
...
describe('IntegerWithUnits', () => {
  it('should create an instance of IntegerWithUnits', () => {
  ...
  it('should have the property units', () => {
    // verify property exists
