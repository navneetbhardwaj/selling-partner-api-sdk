...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForAContentManagement.PostContentDocumentAsinRelationsRequest.prototype);
  }
});
...
describe('PostContentDocumentAsinRelationsRequest', () => {
  it('should create an instance of PostContentDocumentAsinRelationsRequest', () => {
    expect(instance).to.be.a(SellingPartnerApiForAContentManagement.PostContentDocumentAsinRelationsRequest);
  });

  it('should have the property asinSet', () => {
