...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForAContentManagement.StandardTextListBlock();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForAContentManagement.StandardTextListBlock.prototype);
  }
});
...
describe('StandardTextListBlock', () => {
  it('should create an instance of StandardTextListBlock', () => {
  ...
  it('should have the property textList', () => {
    ...
    const expectedValue = generateMockData('TextItem', true);
