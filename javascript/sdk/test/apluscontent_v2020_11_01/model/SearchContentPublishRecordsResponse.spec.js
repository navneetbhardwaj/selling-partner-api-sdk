...
describe('SearchContentPublishRecordsResponse', () => {
  it('should create an instance of SearchContentPublishRecordsResponse', () => {
  ...
  it('should have the property publishRecordList', () => {
    // verify property exists
    expect(instance).to.have.property('publishRecordList');

    // set and verify value
    const expectedValue = generateMockData('PublishRecord', true);
    instance.publishRecordList = expectedValue;
    expect(instance.publishRecordList).to.equal(expectedValue);
  });
