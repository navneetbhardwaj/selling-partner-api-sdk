...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForAContentManagement.StandardTextBlock();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForAContentManagement.StandardTextBlock.prototype);
  }
});
...
describe('StandardTextBlock', () => {
  it('should create an instance of StandardTextBlock', () => {
    expect(instance).to.be.a(SellingPartnerApiForAContentManagement.StandardTextBlock);
  });
