...
describe('ImageCropSpecification', () => {
  it('should create an instance of ImageCropSpecification', () => {
  ...
  it('should have the property size', () => {
    ...
    const expectedValue = generateMockData('ImageDimensions');
  ...
  it('should have the property offset', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('ImageOffsets');
