...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForNotifications.AggregationSettings();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForNotifications.AggregationSettings.prototype);
  }
});
...
describe('AggregationSettings', () => {
  it('should create an instance of AggregationSettings', () => {
    expect(instance).to.be.a(SellingPartnerApiForNotifications.AggregationSettings);
  });

  it('should have the property aggregationTimePeriod', () => {
    // verify property exists
    expect(instance).to.have.property('aggregationTimePeriod');

    // set and verify value
    const expectedValue = generateMockData('AggregationTimePeriod');
