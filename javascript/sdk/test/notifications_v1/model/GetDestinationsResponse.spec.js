...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForNotifications.GetDestinationsResponse.prototype);
  }
});
...
describe('GetDestinationsResponse', () => {
  it('should create an instance of GetDestinationsResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('Destination', true);
