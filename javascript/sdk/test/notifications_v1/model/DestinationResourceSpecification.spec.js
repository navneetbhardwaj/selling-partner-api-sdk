...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForNotifications.DestinationResourceSpecification.prototype);
  }
});
...
describe('DestinationResourceSpecification', () => {
  it('should create an instance of DestinationResourceSpecification', () => {
  ...
  it('should have the property eventBridge', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('EventBridgeResourceSpecification');
