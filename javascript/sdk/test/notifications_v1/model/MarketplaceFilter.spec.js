...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForNotifications.MarketplaceFilter();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForNotifications.MarketplaceFilter.prototype);
  }
});
...
describe('MarketplaceFilter', () => {
  it('should create an instance of MarketplaceFilter', () => {
    expect(instance).to.be.a(SellingPartnerApiForNotifications.MarketplaceFilter);
  });
