...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForNotifications.SqsResource.prototype);
  }
});
...
describe('SqsResource', () => {
  it('should create an instance of SqsResource', () => {
    expect(instance).to.be.a(SellingPartnerApiForNotifications.SqsResource);
  });

  it('should have the property arn', () => {
