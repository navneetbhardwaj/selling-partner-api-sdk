...
describe('PickupChannel', () => {
  it('should create an instance of PickupChannel', () => {
    expect(instance).to.be.a(SellingPartnerApiForSupplySources.PickupChannel);
  });

  it('should have the property inventoryHoldPeriod', () => {
  ...
  it('should have the property inStorePickupConfiguration', () => {
    // verify property exists
    expect(instance).to.have.property('inStorePickupConfiguration');

    // set and verify value
    const expectedValue = generateMockData('InStorePickupConfiguration');
    instance.inStorePickupConfiguration = expectedValue;
    expect(instance.inStorePickupConfiguration).to.equal(expectedValue);
  });

  it('should have the property curbsidePickupConfiguration', () => {
    // verify property exists
    expect(instance).to.have.property('curbsidePickupConfiguration');

    // set and verify value
    const expectedValue = generateMockData('CurbsidePickupConfiguration');
