...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForSupplySources.InStorePickupConfiguration();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForSupplySources.InStorePickupConfiguration.prototype);
  }
});
...
describe('InStorePickupConfiguration', () => {
  it('should create an instance of InStorePickupConfiguration', () => {
  ...
  it('should have the property parkingConfiguration', () => {
    // verify property exists
    expect(instance).to.have.property('parkingConfiguration');

    // set and verify value
    const expectedValue = generateMockData('ParkingConfiguration');
