...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForSupplySources.ThroughputCap();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForSupplySources.ThroughputCap.prototype);
  }
});
...
describe('ThroughputCap', () => {
  it('should create an instance of ThroughputCap', () => {
  ...
  it('should have the property timeUnit', () => {
    // verify property exists
    expect(instance).to.have.property('timeUnit');

    // set and verify value
    const expectedValue = generateMockData('TimeUnit');
