...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForSupplySources.SupplySourceCapabilities.prototype);
  }
});
...
describe('SupplySourceCapabilities', () => {
  it('should create an instance of SupplySourceCapabilities', () => {
    expect(instance).to.be.a(SellingPartnerApiForSupplySources.SupplySourceCapabilities);
  });

  it('should have the property outbound', () => {
    // verify property exists
    expect(instance).to.have.property('outbound');

    // set and verify value
    const expectedValue = generateMockData('OutboundCapability');
    instance.outbound = expectedValue;
    expect(instance.outbound).to.equal(expectedValue);
  });

  it('should have the property services', () => {
    // verify property exists
    expect(instance).to.have.property('services');

    // set and verify value
    const expectedValue = generateMockData('ServicesCapability');
