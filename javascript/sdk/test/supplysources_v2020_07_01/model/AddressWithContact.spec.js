...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForSupplySources.AddressWithContact.prototype);
  }
});
...
describe('AddressWithContact', () => {
  it('should create an instance of AddressWithContact', () => {
