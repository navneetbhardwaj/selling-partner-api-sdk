...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForPricing.CompetitiveSummaryResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForPricing.CompetitiveSummaryResponse.prototype);
  }
});
...
describe('CompetitiveSummaryResponse', () => {
  it('should create an instance of CompetitiveSummaryResponse', () => {
  ...
  it('should have the property body', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('CompetitiveSummaryResponseBody');
