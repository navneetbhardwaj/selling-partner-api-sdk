...
describe('SegmentedFeaturedOffer', () => {
  it('should create an instance of SegmentedFeaturedOffer', () => {
  ...
  it('should have the property featuredOfferSegments', () => {
    // verify property exists
    expect(instance).to.have.property('featuredOfferSegments');

    // set and verify value
    const expectedValue = generateMockData('FeaturedOfferSegment', true);
    instance.featuredOfferSegments = expectedValue;
    expect(instance.featuredOfferSegments).to.equal(expectedValue);
  });
