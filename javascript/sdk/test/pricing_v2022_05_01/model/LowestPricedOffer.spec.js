...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForPricing.LowestPricedOffer();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForPricing.LowestPricedOffer.prototype);
  }
});
...
describe('LowestPricedOffer', () => {
  it('should create an instance of LowestPricedOffer', () => {
    expect(instance).to.be.a(SellingPartnerApiForPricing.LowestPricedOffer);
  });

  it('should have the property lowestPricedOffersInput', () => {
    // verify property exists
    expect(instance).to.have.property('lowestPricedOffersInput');

    // set and verify value
    const expectedValue = generateMockData('LowestPricedOffersInput');
  ...
  it('should have the property offers', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('Offer', true);
