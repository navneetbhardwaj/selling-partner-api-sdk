...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForPricing.BatchResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForPricing.BatchResponse.prototype);
  }
});
...
describe('BatchResponse', () => {
  it('should create an instance of BatchResponse', () => {
