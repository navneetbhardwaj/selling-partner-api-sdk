...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForPricing.CompetitiveSummaryBatchRequest();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForPricing.CompetitiveSummaryBatchRequest.prototype);
  }
});
...
describe('CompetitiveSummaryBatchRequest', () => {
  it('should create an instance of CompetitiveSummaryBatchRequest', () => {
  ...
  it('should have the property requests', () => {
    ...
    const expectedValue = generateMockData('CompetitiveSummaryRequest', true);
