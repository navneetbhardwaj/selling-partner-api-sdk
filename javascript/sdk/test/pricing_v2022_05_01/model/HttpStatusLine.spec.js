...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForPricing.HttpStatusLine();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForPricing.HttpStatusLine.prototype);
  }
});
...
describe('HttpStatusLine', () => {
  it('should create an instance of HttpStatusLine', () => {
    expect(instance).to.be.a(SellingPartnerApiForPricing.HttpStatusLine);
  });
  ...
  it('should have the property reasonPhrase', () => {
    // verify property exists
