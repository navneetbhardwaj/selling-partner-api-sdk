...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForDirectFulfillmentPayments.PartyIdentification.prototype);
  }
});
...
describe('PartyIdentification', () => {
  ...
  it('should have the property taxRegistrationDetails', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('TaxRegistrationDetail', true);
