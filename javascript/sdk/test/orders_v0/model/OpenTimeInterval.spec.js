...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.OpenTimeInterval.prototype);
  }
});
...
describe('OpenTimeInterval', () => {
  it('should create an instance of OpenTimeInterval', () => {
    expect(instance).to.be.a(SellingPartnerApiForOrders.OpenTimeInterval);
  });

  it('should have the property hour', () => {
  ...
  it('should have the property minute', () => {
    // verify property exists
