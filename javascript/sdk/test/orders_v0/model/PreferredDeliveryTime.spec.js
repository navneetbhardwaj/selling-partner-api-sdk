...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForOrders.PreferredDeliveryTime();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForOrders.PreferredDeliveryTime.prototype);
  }
});
...
describe('PreferredDeliveryTime', () => {
  it('should create an instance of PreferredDeliveryTime', () => {
    expect(instance).to.be.a(SellingPartnerApiForOrders.PreferredDeliveryTime);
  });

  it('should have the property businessHours', () => {
    // verify property exists
    expect(instance).to.have.property('businessHours');

    // set and verify value
    const expectedValue = generateMockData('BusinessHours', true);
    instance.businessHours = expectedValue;
    expect(instance.businessHours).to.equal(expectedValue);
  });

  it('should have the property exceptionDates', () => {
    // verify property exists
    expect(instance).to.have.property('exceptionDates');

    // set and verify value
    const expectedValue = generateMockData('ExceptionDates', true);
