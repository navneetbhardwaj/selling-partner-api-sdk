...
describe('OrderRegulatedInfo', () => {
  it('should create an instance of OrderRegulatedInfo', () => {
  ...
  it('should have the property regulatedOrderVerificationStatus', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('RegulatedOrderVerificationStatus');
