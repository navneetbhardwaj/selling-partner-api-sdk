...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.GetOrderBuyerInfoResponse.prototype);
  }
});
...
describe('GetOrderBuyerInfoResponse', () => {
  it('should create an instance of GetOrderBuyerInfoResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('OrderBuyerInfo');
