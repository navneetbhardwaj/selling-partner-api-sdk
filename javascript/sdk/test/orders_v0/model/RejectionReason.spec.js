...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.RejectionReason.prototype);
  }
});
...
describe('RejectionReason', () => {
  it('should create an instance of RejectionReason', () => {
  ...
  it('should have the property rejectionReasonDescription', () => {
    // verify property exists
