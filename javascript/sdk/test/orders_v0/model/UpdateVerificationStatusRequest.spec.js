...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForOrders.UpdateVerificationStatusRequest();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForOrders.UpdateVerificationStatusRequest.prototype);
  }
});
...
describe('UpdateVerificationStatusRequest', () => {
  it('should create an instance of UpdateVerificationStatusRequest', () => {
    expect(instance).to.be.a(SellingPartnerApiForOrders.UpdateVerificationStatusRequest);
  });

  it('should have the property regulatedOrderVerificationStatus', () => {
    // verify property exists
    expect(instance).to.have.property('regulatedOrderVerificationStatus');

    // set and verify value
    const expectedValue = generateMockData('UpdateVerificationStatusRequestBody');
