...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForOrders.VerificationDetails();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForOrders.VerificationDetails.prototype);
  }
});
...
describe('VerificationDetails', () => {
  it('should create an instance of VerificationDetails', () => {
    expect(instance).to.be.a(SellingPartnerApiForOrders.VerificationDetails);
  });

  it('should have the property prescriptionDetail', () => {
    // verify property exists
    expect(instance).to.have.property('prescriptionDetail');

    // set and verify value
    const expectedValue = generateMockData('PrescriptionDetail');
