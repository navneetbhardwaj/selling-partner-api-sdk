...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.AddressExtendedFields.prototype);
  }
});
...
describe('AddressExtendedFields', () => {
  it('should create an instance of AddressExtendedFields', () => {
    expect(instance).to.be.a(SellingPartnerApiForOrders.AddressExtendedFields);
  });

  it('should have the property streetName', () => {
  ...
  it('should have the property streetNumber', () => {
    // verify property exists
  ...
  it('should have the property complement', () => {
    // verify property exists
  ...
  it('should have the property neighborhood', () => {
    // verify property exists
