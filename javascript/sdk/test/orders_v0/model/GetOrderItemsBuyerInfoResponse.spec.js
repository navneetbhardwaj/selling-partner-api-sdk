...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.GetOrderItemsBuyerInfoResponse.prototype);
  }
});
...
describe('GetOrderItemsBuyerInfoResponse', () => {
  it('should create an instance of GetOrderItemsBuyerInfoResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('OrderItemsBuyerInfoList');
