...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForOrders.RegulatedInformation();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForOrders.RegulatedInformation.prototype);
  }
});
...
describe('RegulatedInformation', () => {
  it('should create an instance of RegulatedInformation', () => {
    expect(instance).to.be.a(SellingPartnerApiForOrders.RegulatedInformation);
  });

  it('should have the property fields', () => {
    // verify property exists
    expect(instance).to.have.property('fields');

    // set and verify value
    const expectedValue = generateMockData('RegulatedInformationField', true);
