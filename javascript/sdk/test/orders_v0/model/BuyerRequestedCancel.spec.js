...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForOrders.BuyerRequestedCancel();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForOrders.BuyerRequestedCancel.prototype);
  }
});
...
describe('BuyerRequestedCancel', () => {
  it('should create an instance of BuyerRequestedCancel', () => {
    expect(instance).to.be.a(SellingPartnerApiForOrders.BuyerRequestedCancel);
  });

  it('should have the property isBuyerRequestedCancel', () => {
  ...
  it('should have the property buyerCancelReason', () => {
    // verify property exists
