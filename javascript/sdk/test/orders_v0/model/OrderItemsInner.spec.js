...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForOrders.OrderItemsInner();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForOrders.OrderItemsInner.prototype);
  }
});
...
describe('OrderItemsInner', () => {
  it('should create an instance of OrderItemsInner', () => {
    expect(instance).to.be.a(SellingPartnerApiForOrders.OrderItemsInner);
  });
