...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.OrderBuyerInfo.prototype);
  }
});
...
describe('OrderBuyerInfo', () => {
  it('should create an instance of OrderBuyerInfo', () => {
  ...
  it('should have the property buyerEmail', () => {
    // verify property exists
