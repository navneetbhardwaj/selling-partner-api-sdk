...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.AssociatedItem.prototype);
  }
});
...
describe('AssociatedItem', () => {
  ...
  it('should have the property associationType', () => {
    // verify property exists
    expect(instance).to.have.property('associationType');

    // set and verify value
    const expectedValue = generateMockData('AssociationType');
