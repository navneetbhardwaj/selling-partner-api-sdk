...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.OrdersList.prototype);
  }
});
...
describe('OrdersList', () => {
  it('should create an instance of OrdersList', () => {
  ...
  it('should have the property lastUpdatedBefore', () => {
    // verify property exists
  ...
  it('should have the property createdBefore', () => {
    // verify property exists
