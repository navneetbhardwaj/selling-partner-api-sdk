...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.GetOrderItemsResponse.prototype);
  }
});
...
describe('GetOrderItemsResponse', () => {
  it('should create an instance of GetOrderItemsResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('OrderItemsList');
