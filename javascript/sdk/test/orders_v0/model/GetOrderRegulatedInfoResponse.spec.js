...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForOrders.GetOrderRegulatedInfoResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForOrders.GetOrderRegulatedInfoResponse.prototype);
  }
});
...
describe('GetOrderRegulatedInfoResponse', () => {
  it('should create an instance of GetOrderRegulatedInfoResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForOrders.GetOrderRegulatedInfoResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('OrderRegulatedInfo');
