...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.GetOrdersResponse.prototype);
  }
});
...
describe('GetOrdersResponse', () => {
  it('should create an instance of GetOrdersResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('OrdersList');
