...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.ProductInfoDetail.prototype);
  }
});
...
describe('ProductInfoDetail', () => {
  it('should create an instance of ProductInfoDetail', () => {
    expect(instance).to.be.a(SellingPartnerApiForOrders.ProductInfoDetail);
  });

  it('should have the property numberOfItems', () => {
