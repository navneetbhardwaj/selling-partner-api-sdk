...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.PointsGrantedDetail.prototype);
  }
});
...
describe('PointsGrantedDetail', () => {
  it('should create an instance of PointsGrantedDetail', () => {
  ...
  it('should have the property pointsMonetaryValue', () => {
    // verify property exists
