...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForOrders.GetOrderAddressResponse.prototype);
  }
});
...
describe('GetOrderAddressResponse', () => {
  it('should create an instance of GetOrderAddressResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('OrderAddress');
