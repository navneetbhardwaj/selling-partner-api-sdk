...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.GetCarrierAccountFormInputsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.GetCarrierAccountFormInputsResponse.prototype);
  }
});
...
describe('GetCarrierAccountFormInputsResponse', () => {
  it('should create an instance of GetCarrierAccountFormInputsResponse', () => {
    expect(instance).to.be.a(AmazonShippingApi.GetCarrierAccountFormInputsResponse);
  });

  it('should have the property linkableCarriersList', () => {
    // verify property exists
    expect(instance).to.have.property('linkableCarriersList');

    // set and verify value
    const expectedValue = generateMockData('LinkableCarrier', true);
