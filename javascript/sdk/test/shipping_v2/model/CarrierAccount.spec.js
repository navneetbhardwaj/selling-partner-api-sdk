...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.CarrierAccount();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.CarrierAccount.prototype);
  }
});
...
describe('CarrierAccount', () => {
  it('should create an instance of CarrierAccount', () => {
    expect(instance).to.be.a(AmazonShippingApi.CarrierAccount);
  });

  it('should have the property carrierAccountId', () => {
