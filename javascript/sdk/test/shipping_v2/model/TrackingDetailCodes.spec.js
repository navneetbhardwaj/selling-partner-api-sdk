...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.TrackingDetailCodes();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.TrackingDetailCodes.prototype);
  }
});
...
describe('TrackingDetailCodes', () => {
  it('should create an instance of TrackingDetailCodes', () => {
    expect(instance).to.be.a(AmazonShippingApi.TrackingDetailCodes);
  });

  it('should have the property forward', () => {
    // verify property exists
    expect(instance).to.have.property('forward');

    // set and verify value
    const expectedValue = generateMockData('DetailCodes', true);
    instance.forward = expectedValue;
    expect(instance.forward).to.equal(expectedValue);
  });

  it('should have the property returns', () => {
    // verify property exists
