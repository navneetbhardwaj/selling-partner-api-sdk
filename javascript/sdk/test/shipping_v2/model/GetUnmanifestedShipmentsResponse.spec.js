...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.GetUnmanifestedShipmentsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.GetUnmanifestedShipmentsResponse.prototype);
  }
});
...
describe('GetUnmanifestedShipmentsResponse', () => {
  it('should create an instance of GetUnmanifestedShipmentsResponse', () => {
    expect(instance).to.be.a(AmazonShippingApi.GetUnmanifestedShipmentsResponse);
  });

  it('should have the property unmanifestedCarrierInformationList', () => {
    // verify property exists
    expect(instance).to.have.property('unmanifestedCarrierInformationList');

    // set and verify value
    const expectedValue = generateMockData('UnmanifestedCarrierInformation', true);
