...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.GetCarrierAccountsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.GetCarrierAccountsResponse.prototype);
  }
});
...
describe('GetCarrierAccountsResponse', () => {
  it('should create an instance of GetCarrierAccountsResponse', () => {
    expect(instance).to.be.a(AmazonShippingApi.GetCarrierAccountsResponse);
  });

  it('should have the property activeAccounts', () => {
    // verify property exists
    expect(instance).to.have.property('activeAccounts');

    // set and verify value
    const expectedValue = generateMockData('ActiveAccount', true);
