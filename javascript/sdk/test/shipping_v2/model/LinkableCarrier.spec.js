...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.LinkableCarrier();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.LinkableCarrier.prototype);
  }
});
...
describe('LinkableCarrier', () => {
  it('should create an instance of LinkableCarrier', () => {
  ...
  it('should have the property linkableAccountTypes', () => {
    // verify property exists
    expect(instance).to.have.property('linkableAccountTypes');

    // set and verify value
    const expectedValue = generateMockData('LinkableAccountType', true);
