...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.ActiveAccount();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.ActiveAccount.prototype);
  }
});
...
describe('ActiveAccount', () => {
  it('should create an instance of ActiveAccount', () => {
    expect(instance).to.be.a(AmazonShippingApi.ActiveAccount);
  });
