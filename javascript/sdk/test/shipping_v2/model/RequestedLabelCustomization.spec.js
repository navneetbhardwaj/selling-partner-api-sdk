...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.RequestedLabelCustomization();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.RequestedLabelCustomization.prototype);
  }
});
...
describe('RequestedLabelCustomization', () => {
  it('should create an instance of RequestedLabelCustomization', () => {
    expect(instance).to.be.a(AmazonShippingApi.RequestedLabelCustomization);
  });

  it('should have the property requestAttributes', () => {
    // verify property exists
    expect(instance).to.have.property('requestAttributes');

    // set and verify value
    const expectedValue = generateMockData('LabelAttribute', true);
