...
describe('GetAccessPointsResult', () => {
  it('should create an instance of GetAccessPointsResult', () => {
    expect(instance).to.be.a(AmazonShippingApi.GetAccessPointsResult);
  });

  it('should have the property accessPointsMap', () => {
    // verify property exists
    expect(instance).to.have.property('accessPointsMap');

    // set and verify value
    const expectedValue = generateMockData('{String: Array}');
