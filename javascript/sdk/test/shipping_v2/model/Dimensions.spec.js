...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.Dimensions();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.Dimensions.prototype);
  }
});
...
describe('Dimensions', () => {
  it('should create an instance of Dimensions', () => {
    expect(instance).to.be.a(AmazonShippingApi.Dimensions);
  });
  ...
  it('should have the property unit', () => {
    ...
    // set and verify value
    const expectedValue = ['INCH', 'CENTIMETER', ][0];
