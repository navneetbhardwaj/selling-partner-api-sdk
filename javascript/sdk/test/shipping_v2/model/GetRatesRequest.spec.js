...
describe('GetRatesRequest', () => {
  it('should create an instance of GetRatesRequest', () => {
  ...
  it('should have the property valueAddedServices', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('ValueAddedServiceDetails');
  ...
  it('should have the property carrierAccounts', () => {
    // verify property exists
    expect(instance).to.have.property('carrierAccounts');

    // set and verify value
    const expectedValue = generateMockData('CarrierAccount', true);
