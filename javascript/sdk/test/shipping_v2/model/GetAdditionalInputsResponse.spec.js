...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.GetAdditionalInputsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.GetAdditionalInputsResponse.prototype);
  }
});
...
describe('GetAdditionalInputsResponse', () => {
  it('should create an instance of GetAdditionalInputsResponse', () => {
    expect(instance).to.be.a(AmazonShippingApi.GetAdditionalInputsResponse);
  });
