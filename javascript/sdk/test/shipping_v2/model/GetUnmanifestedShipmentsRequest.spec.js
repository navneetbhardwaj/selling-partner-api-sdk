...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.GetUnmanifestedShipmentsRequest();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.GetUnmanifestedShipmentsRequest.prototype);
  }
});
...
describe('GetUnmanifestedShipmentsRequest', () => {
  it('should create an instance of GetUnmanifestedShipmentsRequest', () => {
    expect(instance).to.be.a(AmazonShippingApi.GetUnmanifestedShipmentsRequest);
  });
