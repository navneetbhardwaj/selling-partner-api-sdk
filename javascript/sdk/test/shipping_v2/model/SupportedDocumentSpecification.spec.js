...
describe('SupportedDocumentSpecification', () => {
  it('should create an instance of SupportedDocumentSpecification', () => {
  ...
  it('should have the property printOptions', () => {
    // verify property exists
    expect(instance).to.have.property('printOptions');

    // set and verify value
    const expectedValue = generateMockData('PrintOption', true);
