...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.CreateClaimResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.CreateClaimResponse.prototype);
  }
});
...
describe('CreateClaimResponse', () => {
  it('should create an instance of CreateClaimResponse', () => {
    expect(instance).to.be.a(AmazonShippingApi.CreateClaimResponse);
  });

  it('should have the property claimId', () => {
