...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.GetRatesResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.GetRatesResponse.prototype);
  }
});
...
describe('GetRatesResponse', () => {
  it('should create an instance of GetRatesResponse', () => {
    expect(instance).to.be.a(AmazonShippingApi.GetRatesResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetRatesResult');
