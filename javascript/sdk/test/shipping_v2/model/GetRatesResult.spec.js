...
describe('GetRatesResult', () => {
  it('should create an instance of GetRatesResult', () => {
  ...
  it('should have the property rates', () => {
    // verify property exists
    expect(instance).to.have.property('rates');

    // set and verify value
    const expectedValue = generateMockData('Rate', true);
    instance.rates = expectedValue;
    expect(instance.rates).to.equal(expectedValue);
  });

  it('should have the property ineligibleRates', () => {
    // verify property exists
    expect(instance).to.have.property('ineligibleRates');

    // set and verify value
    const expectedValue = generateMockData('IneligibleRate', true);
