...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.GetAccessPointsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.GetAccessPointsResponse.prototype);
  }
});
...
describe('GetAccessPointsResponse', () => {
  it('should create an instance of GetAccessPointsResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetAccessPointsResult');
