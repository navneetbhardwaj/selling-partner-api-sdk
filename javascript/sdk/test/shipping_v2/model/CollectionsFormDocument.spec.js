...
describe('CollectionsFormDocument', () => {
  it('should create an instance of CollectionsFormDocument', () => {
    expect(instance).to.be.a(AmazonShippingApi.CollectionsFormDocument);
  });

  it('should have the property base64EncodedContent', () => {
  ...
  it('should have the property documentFormat', () => {
    // verify property exists
