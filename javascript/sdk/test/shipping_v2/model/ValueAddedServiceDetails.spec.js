...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.ValueAddedServiceDetails();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.ValueAddedServiceDetails.prototype);
  }
});
...
describe('ValueAddedServiceDetails', () => {
  it('should create an instance of ValueAddedServiceDetails', () => {
    expect(instance).to.be.a(AmazonShippingApi.ValueAddedServiceDetails);
  });

  it('should have the property collectOnDelivery', () => {
    // verify property exists
    expect(instance).to.have.property('collectOnDelivery');

    // set and verify value
    const expectedValue = generateMockData('CollectOnDelivery');
