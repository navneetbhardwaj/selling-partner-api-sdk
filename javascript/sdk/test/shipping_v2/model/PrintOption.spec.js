...
describe('PrintOption', () => {
  it('should create an instance of PrintOption', () => {
    expect(instance).to.be.a(AmazonShippingApi.PrintOption);
  });

  it('should have the property supportedDPIs', () => {
    // verify property exists
    expect(instance).to.have.property('supportedDPIs');

    // set and verify value
    const expectedValue = generateMockData('Number', true);
    instance.supportedDPIs = expectedValue;
    expect(instance.supportedDPIs).to.equal(expectedValue);
  });

  it('should have the property supportedPageLayouts', () => {
    // verify property exists
