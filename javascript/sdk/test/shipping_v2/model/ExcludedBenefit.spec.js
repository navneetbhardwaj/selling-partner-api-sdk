...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.ExcludedBenefit();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.ExcludedBenefit.prototype);
  }
});
...
describe('ExcludedBenefit', () => {
  it('should create an instance of ExcludedBenefit', () => {
    expect(instance).to.be.a(AmazonShippingApi.ExcludedBenefit);
  });

  it('should have the property benefit', () => {
  ...
  it('should have the property reasonCodes', () => {
    // verify property exists
