...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.UnlinkCarrierAccountResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.UnlinkCarrierAccountResponse.prototype);
  }
});
...
describe('UnlinkCarrierAccountResponse', () => {
  it('should create an instance of UnlinkCarrierAccountResponse', () => {
    expect(instance).to.be.a(AmazonShippingApi.UnlinkCarrierAccountResponse);
  });

  it('should have the property isUnlinked', () => {
