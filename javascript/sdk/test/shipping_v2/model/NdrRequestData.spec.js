...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.NdrRequestData();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.NdrRequestData.prototype);
  }
});
...
describe('NdrRequestData', () => {
  it('should create an instance of NdrRequestData', () => {
    expect(instance).to.be.a(AmazonShippingApi.NdrRequestData);
  });

  it('should have the property rescheduleDate', () => {
  ...
  it('should have the property additionalAddressNotes', () => {
    // verify property exists
