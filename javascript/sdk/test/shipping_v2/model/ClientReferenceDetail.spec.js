...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.ClientReferenceDetail();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.ClientReferenceDetail.prototype);
  }
});
...
describe('ClientReferenceDetail', () => {
  it('should create an instance of ClientReferenceDetail', () => {
    expect(instance).to.be.a(AmazonShippingApi.ClientReferenceDetail);
  });

  it('should have the property clientReferenceType', () => {
    // verify property exists
    expect(instance).to.have.property('clientReferenceType');

    // set and verify value
    const expectedValue = ['IntegratorShipperId', 'IntegratorMerchantId', ][0];
    instance.clientReferenceType = expectedValue;
    expect(instance.clientReferenceType).to.equal(expectedValue);
  });

  it('should have the property clientReferenceId', () => {
    // verify property exists
