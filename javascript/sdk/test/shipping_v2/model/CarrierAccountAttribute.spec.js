...
beforeEach(() => {
  try {
    ...
    instance = Object.create(AmazonShippingApi.CarrierAccountAttribute.prototype);
  }
});
...
describe('CarrierAccountAttribute', () => {
  it('should create an instance of CarrierAccountAttribute', () => {
    expect(instance).to.be.a(AmazonShippingApi.CarrierAccountAttribute);
  });

  it('should have the property attributeName', () => {
  ...
  it('should have the property propertyGroup', () => {
    // verify property exists
