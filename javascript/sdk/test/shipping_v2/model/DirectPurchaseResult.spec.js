...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.DirectPurchaseResult();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.DirectPurchaseResult.prototype);
  }
});
...
describe('DirectPurchaseResult', () => {
  it('should create an instance of DirectPurchaseResult', () => {
  ...
  it('should have the property packageDocumentDetailList', () => {
    // verify property exists
