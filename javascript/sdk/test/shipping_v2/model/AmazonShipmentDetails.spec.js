...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.AmazonShipmentDetails();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.AmazonShipmentDetails.prototype);
  }
});
...
describe('AmazonShipmentDetails', () => {
  it('should create an instance of AmazonShipmentDetails', () => {
    expect(instance).to.be.a(AmazonShippingApi.AmazonShipmentDetails);
  });
