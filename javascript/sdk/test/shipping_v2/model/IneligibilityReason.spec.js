...
beforeEach(() => {
  try {
    ...
    instance = Object.create(AmazonShippingApi.IneligibilityReason.prototype);
  }
});
...
describe('IneligibilityReason', () => {
  it('should create an instance of IneligibilityReason', () => {
  ...
  it('should have the property code', () => {
    ...
    const expectedValue = generateMockData('IneligibilityReasonCode');
