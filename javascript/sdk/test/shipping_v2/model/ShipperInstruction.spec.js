...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.ShipperInstruction();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.ShipperInstruction.prototype);
  }
});
...
describe('ShipperInstruction', () => {
  it('should create an instance of ShipperInstruction', () => {
    expect(instance).to.be.a(AmazonShippingApi.ShipperInstruction);
  });

  it('should have the property deliveryNotes', () => {
