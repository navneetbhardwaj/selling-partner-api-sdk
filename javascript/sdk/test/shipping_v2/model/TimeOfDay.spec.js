...
describe('TimeOfDay', () => {
  it('should create an instance of TimeOfDay', () => {
    expect(instance).to.be.a(AmazonShippingApi.TimeOfDay);
  });

  it('should have the property hourOfDay', () => {
  ...
  it('should have the property minuteOfHour', () => {
    // verify property exists
  ...
  it('should have the property secondOfMinute', () => {
    // verify property exists
