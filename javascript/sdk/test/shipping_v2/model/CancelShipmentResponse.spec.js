...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.CancelShipmentResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.CancelShipmentResponse.prototype);
  }
});
...
describe('CancelShipmentResponse', () => {
  it('should create an instance of CancelShipmentResponse', () => {
    expect(instance).to.be.a(AmazonShippingApi.CancelShipmentResponse);
  });
