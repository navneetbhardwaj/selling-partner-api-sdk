...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.Geocode();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.Geocode.prototype);
  }
});
...
describe('Geocode', () => {
  it('should create an instance of Geocode', () => {
    expect(instance).to.be.a(AmazonShippingApi.Geocode);
  });

  it('should have the property latitude', () => {
  ...
  it('should have the property longitude', () => {
    // verify property exists
