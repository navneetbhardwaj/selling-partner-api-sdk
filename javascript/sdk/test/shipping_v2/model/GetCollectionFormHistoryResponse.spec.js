...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.GetCollectionFormHistoryResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.GetCollectionFormHistoryResponse.prototype);
  }
});
...
describe('GetCollectionFormHistoryResponse', () => {
  it('should create an instance of GetCollectionFormHistoryResponse', () => {
    expect(instance).to.be.a(AmazonShippingApi.GetCollectionFormHistoryResponse);
  });

  it('should have the property collectionFormsHistoryRecordList', () => {
    // verify property exists
    expect(instance).to.have.property('collectionFormsHistoryRecordList');

    // set and verify value
    const expectedValue = generateMockData('CollectionFormsHistoryRecord', true);
  ...
  it('should have the property lastRefreshedDate', () => {
    // verify property exists
