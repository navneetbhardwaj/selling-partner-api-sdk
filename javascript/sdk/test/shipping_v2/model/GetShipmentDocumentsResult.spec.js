...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.GetShipmentDocumentsResult();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.GetShipmentDocumentsResult.prototype);
  }
});
...
describe('GetShipmentDocumentsResult', () => {
  it('should create an instance of GetShipmentDocumentsResult', () => {
  ...
  it('should have the property packageDocumentDetail', () => {
    // verify property exists
    expect(instance).to.have.property('packageDocumentDetail');

    // set and verify value
    const expectedValue = generateMockData('PackageDocumentDetail');
