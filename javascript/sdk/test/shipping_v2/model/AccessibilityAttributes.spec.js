...
beforeEach(() => {
  try {
    ...
    instance = Object.create(AmazonShippingApi.AccessibilityAttributes.prototype);
  }
});
...
describe('AccessibilityAttributes', () => {
  it('should create an instance of AccessibilityAttributes', () => {
    expect(instance).to.be.a(AmazonShippingApi.AccessibilityAttributes);
  });

  it('should have the property distance', () => {
  ...
  it('should have the property driveTime', () => {
    // verify property exists
