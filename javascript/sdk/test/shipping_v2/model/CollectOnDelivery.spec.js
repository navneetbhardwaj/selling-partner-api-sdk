...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.CollectOnDelivery();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.CollectOnDelivery.prototype);
  }
});
...
describe('CollectOnDelivery', () => {
  it('should create an instance of CollectOnDelivery', () => {
    expect(instance).to.be.a(AmazonShippingApi.CollectOnDelivery);
  });
