...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.GoodsOwner();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.GoodsOwner.prototype);
  }
});
...
describe('GoodsOwner', () => {
  it('should create an instance of GoodsOwner', () => {
    expect(instance).to.be.a(AmazonShippingApi.GoodsOwner);
  });

  it('should have the property merchantId', () => {
