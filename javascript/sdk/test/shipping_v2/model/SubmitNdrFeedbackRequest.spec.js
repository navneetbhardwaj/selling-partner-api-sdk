...
beforeEach(() => {
  try {
    instance = new AmazonShippingApi.SubmitNdrFeedbackRequest();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(AmazonShippingApi.SubmitNdrFeedbackRequest.prototype);
  }
});
...
describe('SubmitNdrFeedbackRequest', () => {
  it('should create an instance of SubmitNdrFeedbackRequest', () => {
  ...
  it('should have the property ndrAction', () => {
    // verify property exists
    expect(instance).to.have.property('ndrAction');

    // set and verify value
    const expectedValue = generateMockData('NdrAction');
    instance.ndrAction = expectedValue;
    expect(instance.ndrAction).to.equal(expectedValue);
  });

  it('should have the property ndrRequestData', () => {
    // verify property exists
    expect(instance).to.have.property('ndrRequestData');

    // set and verify value
    const expectedValue = generateMockData('NdrRequestData');
