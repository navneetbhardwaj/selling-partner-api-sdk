...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForFinances.ListFinancialEventsResponse.prototype);
  }
});
...
describe('ListFinancialEventsResponse', () => {
  it('should create an instance of ListFinancialEventsResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('ListFinancialEventsPayload');
