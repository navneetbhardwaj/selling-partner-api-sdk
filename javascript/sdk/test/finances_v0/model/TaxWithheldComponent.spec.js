...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForFinances.TaxWithheldComponent.prototype);
  }
});
...
describe('TaxWithheldComponent', () => {
  it('should create an instance of TaxWithheldComponent', () => {
  ...
  it('should have the property taxesWithheld', () => {
    // verify property exists
