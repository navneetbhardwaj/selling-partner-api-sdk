...
describe('DebtRecoveryItem', () => {
  it('should create an instance of DebtRecoveryItem', () => {
  ...
  it('should have the property originalAmount', () => {
    // verify property exists
  ...
  it('should have the property groupBeginDate', () => {
    // verify property exists
  ...
  it('should have the property groupEndDate', () => {
    // verify property exists
