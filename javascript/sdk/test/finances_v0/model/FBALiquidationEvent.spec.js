...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForFinances.FBALiquidationEvent.prototype);
  }
});
...
describe('FBALiquidationEvent', () => {
  it('should create an instance of FBALiquidationEvent', () => {
  ...
  it('should have the property originalRemovalOrderId', () => {
    // verify property exists
  ...
  it('should have the property liquidationProceedsAmount', () => {
    // verify property exists
  ...
  it('should have the property liquidationFeeAmount', () => {
    // verify property exists
