...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForFinances.ListFinancialEventsPayload.prototype);
  }
});
...
describe('ListFinancialEventsPayload', () => {
  it('should create an instance of ListFinancialEventsPayload', () => {
  ...
  it('should have the property financialEvents', () => {
    // verify property exists
    expect(instance).to.have.property('financialEvents');

    // set and verify value
    const expectedValue = generateMockData('FinancialEvents');
