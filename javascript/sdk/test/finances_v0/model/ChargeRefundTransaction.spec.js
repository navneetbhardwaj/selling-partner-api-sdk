...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForFinances.ChargeRefundTransaction.prototype);
  }
});
...
describe('ChargeRefundTransaction', () => {
  it('should create an instance of ChargeRefundTransaction', () => {
  ...
  it('should have the property chargeType', () => {
    // verify property exists
