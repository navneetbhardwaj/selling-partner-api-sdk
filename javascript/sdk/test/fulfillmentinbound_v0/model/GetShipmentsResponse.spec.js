...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForFulfillmentInbound.GetShipmentsResponse.prototype);
  }
});
...
describe('GetShipmentsResponse', () => {
  it('should create an instance of GetShipmentsResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetShipmentsResult');
