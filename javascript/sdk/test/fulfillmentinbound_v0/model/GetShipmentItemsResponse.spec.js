...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForFulfillmentInbound.GetShipmentItemsResponse.prototype);
  }
});
...
describe('GetShipmentItemsResponse', () => {
  it('should create an instance of GetShipmentItemsResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetShipmentItemsResult');
