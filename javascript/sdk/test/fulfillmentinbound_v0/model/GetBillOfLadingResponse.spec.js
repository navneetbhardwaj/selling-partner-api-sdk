...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForFulfillmentInbound.GetBillOfLadingResponse.prototype);
  }
});
...
describe('GetBillOfLadingResponse', () => {
  it('should create an instance of GetBillOfLadingResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('BillOfLadingDownloadURL');
