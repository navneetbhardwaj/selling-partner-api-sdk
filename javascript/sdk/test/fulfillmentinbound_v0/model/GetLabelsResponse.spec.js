...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForFulfillmentInbound.GetLabelsResponse.prototype);
  }
});
...
describe('GetLabelsResponse', () => {
  it('should create an instance of GetLabelsResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('LabelDownloadURL');
