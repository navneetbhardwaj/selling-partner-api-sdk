...
describe('CreateReportScheduleSpecification', () => {
  it('should create an instance of CreateReportScheduleSpecification', () => {
  ...
  it('should have the property period', () => {
    ...
    // set and verify value
    const expectedValue = ['PT5M', 'PT15M', 'PT30M', 'PT1H', 'PT2H', 'PT4H', 'PT8H', 'PT12H', 'P1D', 'P2D', 'P3D', 'PT84H', 'P7D', 'P14D', 'P15D', 'P18D', 'P30D', 'P1M', ][0];
