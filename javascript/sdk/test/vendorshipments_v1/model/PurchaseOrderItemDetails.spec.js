...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForRetailProcurementShipments.PurchaseOrderItemDetails.prototype);
  }
});
...
describe('PurchaseOrderItemDetails', () => {
  it('should create an instance of PurchaseOrderItemDetails', () => {
