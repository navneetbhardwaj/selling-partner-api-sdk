...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForRetailProcurementShipments.ItemQuantity.prototype);
  }
});
...
describe('ItemQuantity', () => {
  ...
  it('should have the property totalWeight', () => {
    // verify property exists
    expect(instance).to.have.property('totalWeight');

    // set and verify value
    const expectedValue = generateMockData('TotalWeight');
    instance.totalWeight = expectedValue;
    expect(instance.totalWeight).to.equal(expectedValue);
  });
