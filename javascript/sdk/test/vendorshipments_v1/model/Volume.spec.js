...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForRetailProcurementShipments.Volume.prototype);
  }
});
...
describe('Volume', () => {
  it('should create an instance of Volume', () => {
  ...
  it('should have the property unitOfMeasure', () => {
    ...
    const expectedValue = ['CuFt', 'CuIn', 'CuM', 'CuY', ][0];
