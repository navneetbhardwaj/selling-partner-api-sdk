...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForRetailProcurementShipments.Route.prototype);
  }
});
...
describe('Route', () => {
  ...
  it('should have the property stops', () => {
    // verify property exists
    expect(instance).to.have.property('stops');

    // set and verify value
    const expectedValue = generateMockData('Stop', true);
