...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForRetailProcurementShipments.PackedItems.prototype);
  }
});
...
describe('PackedItems', () => {
  it('should create an instance of PackedItems', () => {
  ...
  it('should have the property itemDetails', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('PackageItemDetails');
