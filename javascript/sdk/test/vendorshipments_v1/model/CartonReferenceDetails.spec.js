...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForRetailProcurementShipments.CartonReferenceDetails.prototype);
  }
});
...
describe('CartonReferenceDetails', () => {
  it('should create an instance of CartonReferenceDetails', () => {
  ...
  it('should have the property cartonReferenceNumbers', () => {
    // verify property exists
