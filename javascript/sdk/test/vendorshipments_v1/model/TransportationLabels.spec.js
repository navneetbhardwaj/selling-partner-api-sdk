...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForRetailProcurementShipments.TransportationLabels.prototype);
  }
});
...
describe('TransportationLabels', () => {
  it('should create an instance of TransportationLabels', () => {
  ...
  it('should have the property transportLabels', () => {
    // verify property exists
    expect(instance).to.have.property('transportLabels');

    // set and verify value
    const expectedValue = generateMockData('TransportLabel', true);
    instance.transportLabels = expectedValue;
    expect(instance.transportLabels).to.equal(expectedValue);
  });
