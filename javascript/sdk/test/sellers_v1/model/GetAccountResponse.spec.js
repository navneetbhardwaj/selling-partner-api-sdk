...
beforeEach(() => {
  try {
    ...
    instance = Object.create(TheSellingPartnerApiForSellers.GetAccountResponse.prototype);
  }
});
...
describe('GetAccountResponse', () => {
  it('should create an instance of GetAccountResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('Account');
