...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForSales.GetOrderMetricsResponse.prototype);
  }
});
...
describe('GetOrderMetricsResponse', () => {
  it('should create an instance of GetOrderMetricsResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('OrderMetricsInterval', true);
