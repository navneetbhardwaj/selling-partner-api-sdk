...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForSales.Money();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForSales.Money.prototype);
  }
});
...
describe('Money', () => {
  it('should create an instance of Money', () => {
    expect(instance).to.be.a(SellingPartnerApiForSales.Money);
  });
