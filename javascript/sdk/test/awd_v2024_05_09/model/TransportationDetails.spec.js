...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForAmazonWarehousingAndDistribution.TransportationDetails();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForAmazonWarehousingAndDistribution.TransportationDetails.prototype);
  }
});
...
describe('TransportationDetails', () => {
  ...
  it('should have the property trackingDetails', () => {
    ...
    const expectedValue = generateMockData('TrackingDetails', true);
