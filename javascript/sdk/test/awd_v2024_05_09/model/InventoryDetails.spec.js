...
beforeEach(() => {
  try {
    ...
    instance = Object.create(TheSellingPartnerApiForAmazonWarehousingAndDistribution.InventoryDetails.prototype);
  }
});
...
describe('InventoryDetails', () => {
  ...
  it('should have the property availableDistributableQuantity', () => {
  ...
  it('should have the property replenishmentQuantity', () => {
    // verify property exists
  ...
  it('should have the property reservedDistributableQuantity', () => {
    // verify property exists
