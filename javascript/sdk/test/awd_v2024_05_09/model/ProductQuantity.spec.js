...
describe('ProductQuantity', () => {
  it('should create an instance of ProductQuantity', () => {
  ...
  it('should have the property attributes', () => {
    ...
    const expectedValue = generateMockData('ProductAttribute', true);
  ...
  it('should have the property prepDetails', () => {
    // verify property exists
    expect(instance).to.have.property('prepDetails');

    // set and verify value
    const expectedValue = generateMockData('PrepDetails');
    instance.prepDetails = expectedValue;
    expect(instance.prepDetails).to.equal(expectedValue);
  });
