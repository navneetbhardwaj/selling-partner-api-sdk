...
beforeEach(() => {
  try {
    ...
    instance = Object.create(TheSellingPartnerApiForAmazonWarehousingAndDistribution.SkuIneligibilityReason.prototype);
  }
});
...
describe('SkuIneligibilityReason', () => {
  it('should create an instance of SkuIneligibilityReason', () => {
