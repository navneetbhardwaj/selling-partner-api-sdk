...
beforeEach(() => {
  try {
    ...
    instance = Object.create(TheSellingPartnerApiForAmazonWarehousingAndDistribution.PackageWeight.prototype);
  }
});
...
describe('PackageWeight', () => {
  it('should create an instance of PackageWeight', () => {
  ...
  it('should have the property unitOfMeasurement', () => {
    ...
    const expectedValue = generateMockData('WeightUnitOfMeasurement');
