...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForReplenishment.Promotion();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForReplenishment.Promotion.prototype);
  }
});
...
describe('Promotion', () => {
  it('should create an instance of Promotion', () => {
    expect(instance).to.be.a(SellingPartnerApiForReplenishment.Promotion);
  });
  ...
  it('should have the property sellingPartnerFundedBaseDiscount', () => {
    ...
    const expectedValue = generateMockData('DiscountFunding');
