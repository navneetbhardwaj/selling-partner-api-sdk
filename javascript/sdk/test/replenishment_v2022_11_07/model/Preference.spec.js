...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForReplenishment.Preference();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForReplenishment.Preference.prototype);
  }
});
...
describe('Preference', () => {
  it('should create an instance of Preference', () => {
  ...
  it('should have the property autoEnrollment', () => {
    ...
    const expectedValue = generateMockData('AutoEnrollmentPreference', true);
