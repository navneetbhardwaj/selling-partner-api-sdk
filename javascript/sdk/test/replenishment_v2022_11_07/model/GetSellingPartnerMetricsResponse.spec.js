...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForReplenishment.GetSellingPartnerMetricsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForReplenishment.GetSellingPartnerMetricsResponse.prototype);
  }
});
...
describe('GetSellingPartnerMetricsResponse', () => {
  it('should create an instance of GetSellingPartnerMetricsResponse', () => {
  ...
  it('should have the property metrics', () => {
    ...
    const expectedValue = generateMockData('GetSellingPartnerMetricsResponseMetric', true);
