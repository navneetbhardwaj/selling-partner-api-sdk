...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForReplenishment.ListOffersResponse.prototype);
  }
});
...
describe('ListOffersResponse', () => {
  it('should create an instance of ListOffersResponse', () => {
  ...
  it('should have the property offers', () => {
    ...
    const expectedValue = generateMockData('ListOffersResponseOffer', true);
