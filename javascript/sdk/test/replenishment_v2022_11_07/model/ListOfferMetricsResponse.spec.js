...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForReplenishment.ListOfferMetricsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForReplenishment.ListOfferMetricsResponse.prototype);
  }
});
...
describe('ListOfferMetricsResponse', () => {
  it('should create an instance of ListOfferMetricsResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForReplenishment.ListOfferMetricsResponse);
  });
  ...
  it('should have the property offers', () => {
    ...
    const expectedValue = generateMockData('ListOfferMetricsResponseOffer', true);
  ...
  it('should have the property pagination', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('PaginationResponse');
