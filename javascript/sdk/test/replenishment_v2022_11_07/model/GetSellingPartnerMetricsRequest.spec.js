...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForReplenishment.GetSellingPartnerMetricsRequest.prototype);
  }
});
...
describe('GetSellingPartnerMetricsRequest', () => {
  it('should create an instance of GetSellingPartnerMetricsRequest', () => {
  ...
  it('should have the property metrics', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('Metric', true);
