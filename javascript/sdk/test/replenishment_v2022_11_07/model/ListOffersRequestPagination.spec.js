...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForReplenishment.ListOffersRequestPagination.prototype);
  }
});
...
describe('ListOffersRequestPagination', () => {
  it('should create an instance of ListOffersRequestPagination', () => {
    expect(instance).to.be.a(SellingPartnerApiForReplenishment.ListOffersRequestPagination);
  });

  it('should have the property limit', () => {
