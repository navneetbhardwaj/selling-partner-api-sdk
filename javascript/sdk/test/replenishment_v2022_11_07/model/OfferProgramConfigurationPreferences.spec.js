...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForReplenishment.OfferProgramConfigurationPreferences.prototype);
  }
});
...
describe('OfferProgramConfigurationPreferences', () => {
  it('should create an instance of OfferProgramConfigurationPreferences', () => {
    expect(instance).to.be.a(SellingPartnerApiForReplenishment.OfferProgramConfigurationPreferences);
  });

  it('should have the property autoEnrollment', () => {
    // verify property exists
    expect(instance).to.have.property('autoEnrollment');

    // set and verify value
    const expectedValue = generateMockData('AutoEnrollmentPreference');
