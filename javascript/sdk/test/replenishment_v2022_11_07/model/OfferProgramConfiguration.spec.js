...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForReplenishment.OfferProgramConfiguration.prototype);
  }
});
...
describe('OfferProgramConfiguration', () => {
  it('should create an instance of OfferProgramConfiguration', () => {
  ...
  it('should have the property preferences', () => {
    ...
    const expectedValue = generateMockData('OfferProgramConfigurationPreferences');
  ...
  it('should have the property promotions', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('OfferProgramConfigurationPromotions');
    instance.promotions = expectedValue;
    expect(instance.promotions).to.equal(expectedValue);
  });

  it('should have the property enrollmentMethod', () => {
    // verify property exists
    expect(instance).to.have.property('enrollmentMethod');

    // set and verify value
    const expectedValue = generateMockData('EnrollmentMethod');
