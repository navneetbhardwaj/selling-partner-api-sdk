...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForMessaging.GetMessagingActionResponseEmbedded();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForMessaging.GetMessagingActionResponseEmbedded.prototype);
  }
});
...
describe('GetMessagingActionResponseEmbedded', () => {
  it('should create an instance of GetMessagingActionResponseEmbedded', () => {
  ...
  it('should have the property schema', () => {
    ...
    const expectedValue = generateMockData('GetSchemaResponse');
