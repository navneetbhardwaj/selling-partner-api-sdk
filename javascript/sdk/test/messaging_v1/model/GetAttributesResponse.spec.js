...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForMessaging.GetAttributesResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForMessaging.GetAttributesResponse.prototype);
  }
});
...
describe('GetAttributesResponse', () => {
  it('should create an instance of GetAttributesResponse', () => {
  ...
  it('should have the property buyer', () => {
    ...
    const expectedValue = generateMockData('GetAttributesResponseBuyer');
