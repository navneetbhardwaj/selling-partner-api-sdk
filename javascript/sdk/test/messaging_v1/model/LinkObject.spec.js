...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForMessaging.LinkObject();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForMessaging.LinkObject.prototype);
  }
});
...
describe('LinkObject', () => {
  it('should create an instance of LinkObject', () => {
    expect(instance).to.be.a(SellingPartnerApiForMessaging.LinkObject);
  });

  it('should have the property href', () => {
