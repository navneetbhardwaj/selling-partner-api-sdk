...
describe('GetMessagingActionsForOrderResponseEmbedded', () => {
  it('should create an instance of GetMessagingActionsForOrderResponseEmbedded', () => {
  ...
  it('should have the property actions', () => {
    ...
    const expectedValue = generateMockData('GetMessagingActionResponse', true);
