...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForMessaging.GetMessagingActionsForOrderResponse.prototype);
  }
});
...
describe('GetMessagingActionsForOrderResponse', () => {
  it('should create an instance of GetMessagingActionsForOrderResponse', () => {
  ...
  it('should have the property links', () => {
    ...
    const expectedValue = generateMockData('GetMessagingActionsForOrderResponseLinks');
  ...
  it('should have the property embedded', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('GetMessagingActionsForOrderResponseEmbedded');
