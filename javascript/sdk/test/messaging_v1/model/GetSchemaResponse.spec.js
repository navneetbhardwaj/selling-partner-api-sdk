...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForMessaging.GetSchemaResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForMessaging.GetSchemaResponse.prototype);
  }
});
...
describe('GetSchemaResponse', () => {
  it('should create an instance of GetSchemaResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForMessaging.GetSchemaResponse);
  });
  ...
  it('should have the property links', () => {
    ...
    const expectedValue = generateMockData('GetSchemaResponseLinks');
