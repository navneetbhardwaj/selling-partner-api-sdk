...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForMessaging.MessagingAction();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForMessaging.MessagingAction.prototype);
  }
});
...
describe('MessagingAction', () => {
  it('should create an instance of MessagingAction', () => {
    expect(instance).to.be.a(SellingPartnerApiForMessaging.MessagingAction);
  });
