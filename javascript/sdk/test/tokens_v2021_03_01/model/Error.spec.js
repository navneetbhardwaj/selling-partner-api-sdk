...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForTokens.Error();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForTokens.Error.prototype);
  }
});
...
describe('Error', () => {
  it('should create an instance of Error', () => {
    expect(instance).to.be.a(SellingPartnerApiForTokens.Error);
  });
