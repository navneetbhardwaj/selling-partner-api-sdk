...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForRetailProcurementTransactionStatus.GetTransactionResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForRetailProcurementTransactionStatus.GetTransactionResponse.prototype);
  }
});
...
describe('GetTransactionResponse', () => {
  it('should create an instance of GetTransactionResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForRetailProcurementTransactionStatus.GetTransactionResponse);
  });
