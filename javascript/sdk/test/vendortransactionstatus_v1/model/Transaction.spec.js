...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForRetailProcurementTransactionStatus.Transaction();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForRetailProcurementTransactionStatus.Transaction.prototype);
  }
});
...
describe('Transaction', () => {
  it('should create an instance of Transaction', () => {
    expect(instance).to.be.a(SellingPartnerApiForRetailProcurementTransactionStatus.Transaction);
  });
  ...
  it('should have the property status', () => {
    ...
    // set and verify value
    const expectedValue = ['Failure', 'Processing', 'Success', ][0];
