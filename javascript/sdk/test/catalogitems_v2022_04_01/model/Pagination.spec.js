...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForCatalogItems.Pagination();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForCatalogItems.Pagination.prototype);
  }
});
...
describe('Pagination', () => {
  it('should create an instance of Pagination', () => {
    expect(instance).to.be.a(SellingPartnerApiForCatalogItems.Pagination);
  });
