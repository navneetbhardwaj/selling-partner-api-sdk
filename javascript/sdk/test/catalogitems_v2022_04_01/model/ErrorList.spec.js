...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForCatalogItems.ErrorList();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForCatalogItems.ErrorList.prototype);
  }
});
...
describe('ErrorList', () => {
  it('should create an instance of ErrorList', () => {
    expect(instance).to.be.a(SellingPartnerApiForCatalogItems.ErrorList);
  });
