...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForCatalogItems.ItemProductTypeByMarketplace();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForCatalogItems.ItemProductTypeByMarketplace.prototype);
  }
});
...
describe('ItemProductTypeByMarketplace', () => {
  it('should create an instance of ItemProductTypeByMarketplace', () => {
    expect(instance).to.be.a(SellingPartnerApiForCatalogItems.ItemProductTypeByMarketplace);
  });
