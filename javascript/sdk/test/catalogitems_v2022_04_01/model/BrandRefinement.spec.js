...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForCatalogItems.BrandRefinement.prototype);
  }
});
...
describe('BrandRefinement', () => {
  it('should create an instance of BrandRefinement', () => {
