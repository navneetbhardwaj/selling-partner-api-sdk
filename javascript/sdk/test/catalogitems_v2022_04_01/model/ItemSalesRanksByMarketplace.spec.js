...
describe('ItemSalesRanksByMarketplace', () => {
  it('should create an instance of ItemSalesRanksByMarketplace', () => {
  ...
  it('should have the property classificationRanks', () => {
    // verify property exists
    expect(instance).to.have.property('classificationRanks');

    // set and verify value
    const expectedValue = generateMockData('ItemClassificationSalesRank', true);
    instance.classificationRanks = expectedValue;
    expect(instance.classificationRanks).to.equal(expectedValue);
  });

  it('should have the property displayGroupRanks', () => {
    // verify property exists
    expect(instance).to.have.property('displayGroupRanks');

    // set and verify value
    const expectedValue = generateMockData('ItemDisplayGroupSalesRank', true);
