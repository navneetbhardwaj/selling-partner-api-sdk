...
describe('ItemDimensionsByMarketplace', () => {
  it('should create an instance of ItemDimensionsByMarketplace', () => {
  ...
  it('should have the property item', () => {
    // verify property exists
  ...
  it('should have the property _package', () => {
    // verify property exists
