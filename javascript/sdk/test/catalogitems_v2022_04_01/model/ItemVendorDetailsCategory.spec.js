...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForCatalogItems.ItemVendorDetailsCategory();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForCatalogItems.ItemVendorDetailsCategory.prototype);
  }
});
...
describe('ItemVendorDetailsCategory', () => {
  it('should create an instance of ItemVendorDetailsCategory', () => {
    expect(instance).to.be.a(SellingPartnerApiForCatalogItems.ItemVendorDetailsCategory);
  });
