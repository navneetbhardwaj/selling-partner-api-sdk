...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForCatalogItems.ItemIdentifier.prototype);
  }
});
...
describe('ItemIdentifier', () => {
  it('should create an instance of ItemIdentifier', () => {
    expect(instance).to.be.a(SellingPartnerApiForCatalogItems.ItemIdentifier);
  });

  it('should have the property identifierType', () => {
