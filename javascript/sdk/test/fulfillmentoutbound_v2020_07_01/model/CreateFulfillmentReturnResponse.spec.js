...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.CreateFulfillmentReturnResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.CreateFulfillmentReturnResponse.prototype);
  }
});
...
describe('CreateFulfillmentReturnResponse', () => {
  it('should create an instance of CreateFulfillmentReturnResponse', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.CreateFulfillmentReturnResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('CreateFulfillmentReturnResult');
