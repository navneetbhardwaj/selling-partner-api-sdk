...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.GetPackageTrackingDetailsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.GetPackageTrackingDetailsResponse.prototype);
  }
});
...
describe('GetPackageTrackingDetailsResponse', () => {
  it('should create an instance of GetPackageTrackingDetailsResponse', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.GetPackageTrackingDetailsResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('PackageTrackingDetails');
