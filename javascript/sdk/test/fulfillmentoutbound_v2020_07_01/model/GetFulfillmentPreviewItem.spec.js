...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.GetFulfillmentPreviewItem();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.GetFulfillmentPreviewItem.prototype);
  }
});
...
describe('GetFulfillmentPreviewItem', () => {
  it('should create an instance of GetFulfillmentPreviewItem', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.GetFulfillmentPreviewItem);
  });
