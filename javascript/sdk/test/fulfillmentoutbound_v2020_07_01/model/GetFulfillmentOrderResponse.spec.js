...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.GetFulfillmentOrderResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.GetFulfillmentOrderResponse.prototype);
  }
});
...
describe('GetFulfillmentOrderResponse', () => {
  it('should create an instance of GetFulfillmentOrderResponse', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.GetFulfillmentOrderResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetFulfillmentOrderResult');
