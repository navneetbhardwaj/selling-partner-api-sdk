...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.ListAllFulfillmentOrdersResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.ListAllFulfillmentOrdersResponse.prototype);
  }
});
...
describe('ListAllFulfillmentOrdersResponse', () => {
  it('should create an instance of ListAllFulfillmentOrdersResponse', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.ListAllFulfillmentOrdersResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('ListAllFulfillmentOrdersResult');
