...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.Money();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.Money.prototype);
  }
});
...
describe('Money', () => {
  it('should create an instance of Money', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.Money);
  });
