...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.GetDeliveryOffersResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.GetDeliveryOffersResponse.prototype);
  }
});
...
describe('GetDeliveryOffersResponse', () => {
  it('should create an instance of GetDeliveryOffersResponse', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.GetDeliveryOffersResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetDeliveryOffersResult');
