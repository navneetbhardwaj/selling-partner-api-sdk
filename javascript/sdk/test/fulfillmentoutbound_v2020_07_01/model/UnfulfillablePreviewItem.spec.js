...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.UnfulfillablePreviewItem.prototype);
  }
});
...
describe('UnfulfillablePreviewItem', () => {
  it('should create an instance of UnfulfillablePreviewItem', () => {
  ...
  it('should have the property itemUnfulfillableReasons', () => {
    // verify property exists
    expect(instance).to.have.property('itemUnfulfillableReasons');

    // set and verify value
    const expectedValue = generateMockData('String', true);
    instance.itemUnfulfillableReasons = expectedValue;
    expect(instance.itemUnfulfillableReasons).to.equal(expectedValue);
  });
