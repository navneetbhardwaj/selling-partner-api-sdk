...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.ProductIdentifier();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.ProductIdentifier.prototype);
  }
});
...
describe('ProductIdentifier', () => {
  it('should create an instance of ProductIdentifier', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.ProductIdentifier);
  });

  it('should have the property merchantSku', () => {
