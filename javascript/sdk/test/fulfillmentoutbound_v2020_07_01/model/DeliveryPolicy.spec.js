...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.DeliveryPolicy();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.DeliveryPolicy.prototype);
  }
});
...
describe('DeliveryPolicy', () => {
  it('should create an instance of DeliveryPolicy', () => {
  ...
  it('should have the property message', () => {
    ...
    const expectedValue = generateMockData('DeliveryMessage');
