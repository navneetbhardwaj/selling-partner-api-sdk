...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.DeliveryDocument();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.DeliveryDocument.prototype);
  }
});
...
describe('DeliveryDocument', () => {
  it('should create an instance of DeliveryDocument', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.DeliveryDocument);
  });

  it('should have the property documentType', () => {
