...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.GetFeatureInventoryResponse.prototype);
  }
});
...
describe('GetFeatureInventoryResponse', () => {
  it('should create an instance of GetFeatureInventoryResponse', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.GetFeatureInventoryResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetFeatureInventoryResult');
