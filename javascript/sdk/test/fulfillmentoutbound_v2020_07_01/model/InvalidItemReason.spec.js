...
describe('InvalidItemReason', () => {
  it('should create an instance of InvalidItemReason', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.InvalidItemReason);
  });

  it('should have the property invalidItemReasonCode', () => {
    // verify property exists
    expect(instance).to.have.property('invalidItemReasonCode');

    // set and verify value
    const expectedValue = generateMockData('InvalidItemReasonCode');
