...
describe('GetFeatureInventoryResult', () => {
  it('should create an instance of GetFeatureInventoryResult', () => {
  ...
  it('should have the property featureSkus', () => {
    // verify property exists
    expect(instance).to.have.property('featureSkus');

    // set and verify value
    const expectedValue = generateMockData('FeatureSku', true);
