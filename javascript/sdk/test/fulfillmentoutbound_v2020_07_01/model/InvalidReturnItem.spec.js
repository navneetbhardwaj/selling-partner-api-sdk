...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.InvalidReturnItem.prototype);
  }
});
...
describe('InvalidReturnItem', () => {
  it('should create an instance of InvalidReturnItem', () => {
  ...
  it('should have the property invalidItemReason', () => {
    // verify property exists
    expect(instance).to.have.property('invalidItemReason');

    // set and verify value
    const expectedValue = generateMockData('InvalidItemReason');
