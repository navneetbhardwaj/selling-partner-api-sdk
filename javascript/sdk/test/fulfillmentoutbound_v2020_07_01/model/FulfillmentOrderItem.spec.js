...
describe('FulfillmentOrderItem', () => {
  it('should create an instance of FulfillmentOrderItem', () => {
  ...
  it('should have the property cancelledQuantity', () => {
    // verify property exists
  ...
  it('should have the property estimatedShipDate', () => {
    // verify property exists
