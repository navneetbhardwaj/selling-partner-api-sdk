...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.GetFulfillmentPreviewResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.GetFulfillmentPreviewResponse.prototype);
  }
});
...
describe('GetFulfillmentPreviewResponse', () => {
  it('should create an instance of GetFulfillmentPreviewResponse', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.GetFulfillmentPreviewResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetFulfillmentPreviewResult');
