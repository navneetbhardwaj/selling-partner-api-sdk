...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.Origin();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.Origin.prototype);
  }
});
...
describe('Origin', () => {
  it('should create an instance of Origin', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.Origin);
  });
