...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.GetFeaturesResult.prototype);
  }
});
...
describe('GetFeaturesResult', () => {
  it('should create an instance of GetFeaturesResult', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.GetFeaturesResult);
  });

  it('should have the property features', () => {
    // verify property exists
    expect(instance).to.have.property('features');

    // set and verify value
    const expectedValue = generateMockData('Feature', true);
