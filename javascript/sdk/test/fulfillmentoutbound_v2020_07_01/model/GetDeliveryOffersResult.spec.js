...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.GetDeliveryOffersResult();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.GetDeliveryOffersResult.prototype);
  }
});
...
describe('GetDeliveryOffersResult', () => {
  it('should create an instance of GetDeliveryOffersResult', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.GetDeliveryOffersResult);
  });

  it('should have the property deliveryOffers', () => {
    // verify property exists
    expect(instance).to.have.property('deliveryOffers');

    // set and verify value
    const expectedValue = generateMockData('DeliveryOffer', true);
