...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.SubmitFulfillmentOrderStatusUpdateRequest();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.SubmitFulfillmentOrderStatusUpdateRequest.prototype);
  }
});
...
describe('SubmitFulfillmentOrderStatusUpdateRequest', () => {
  it('should create an instance of SubmitFulfillmentOrderStatusUpdateRequest', () => {
