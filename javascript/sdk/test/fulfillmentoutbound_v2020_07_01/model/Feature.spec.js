...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.Feature();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.Feature.prototype);
  }
});
...
describe('Feature', () => {
  ...
  it('should have the property featureDescription', () => {
    // verify property exists
  ...
  it('should have the property sellerEligible', () => {
    // verify property exists
