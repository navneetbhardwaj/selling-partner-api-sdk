...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.GetFulfillmentPreviewResult();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.GetFulfillmentPreviewResult.prototype);
  }
});
...
describe('GetFulfillmentPreviewResult', () => {
  it('should create an instance of GetFulfillmentPreviewResult', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.GetFulfillmentPreviewResult);
  });

  it('should have the property fulfillmentPreviews', () => {
    // verify property exists
    expect(instance).to.have.property('fulfillmentPreviews');

    // set and verify value
    const expectedValue = generateMockData('FulfillmentPreview', true);
