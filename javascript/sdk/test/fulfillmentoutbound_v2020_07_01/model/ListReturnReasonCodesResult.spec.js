...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.ListReturnReasonCodesResult();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.ListReturnReasonCodesResult.prototype);
  }
});
...
describe('ListReturnReasonCodesResult', () => {
  it('should create an instance of ListReturnReasonCodesResult', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.ListReturnReasonCodesResult);
  });

  it('should have the property reasonCodeDetails', () => {
    // verify property exists
    expect(instance).to.have.property('reasonCodeDetails');

    // set and verify value
    const expectedValue = generateMockData('ReasonCodeDetails', true);
