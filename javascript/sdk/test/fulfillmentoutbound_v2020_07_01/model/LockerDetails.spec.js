...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.LockerDetails.prototype);
  }
});
...
describe('LockerDetails', () => {
  it('should create an instance of LockerDetails', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.LockerDetails);
  });

  it('should have the property lockerNumber', () => {
  ...
  it('should have the property lockerAccessCode', () => {
    // verify property exists
