...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.GetFeaturesResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.GetFeaturesResponse.prototype);
  }
});
...
describe('GetFeaturesResponse', () => {
  it('should create an instance of GetFeaturesResponse', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.GetFeaturesResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetFeaturesResult');
