...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.CreateFulfillmentReturnResult.prototype);
  }
});
...
describe('CreateFulfillmentReturnResult', () => {
  it('should create an instance of CreateFulfillmentReturnResult', () => {
  ...
  it('should have the property invalidReturnItems', () => {
    // verify property exists
    expect(instance).to.have.property('invalidReturnItems');

    // set and verify value
    const expectedValue = generateMockData('InvalidReturnItem', true);
