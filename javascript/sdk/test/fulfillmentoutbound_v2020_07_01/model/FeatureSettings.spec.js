...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.FeatureSettings();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.FeatureSettings.prototype);
  }
});
...
describe('FeatureSettings', () => {
  it('should create an instance of FeatureSettings', () => {
  ...
  it('should have the property featureFulfillmentPolicy', () => {
    // verify property exists
    expect(instance).to.have.property('featureFulfillmentPolicy');

    // set and verify value
    const expectedValue = ['Required', 'NotRequired', ][0];
