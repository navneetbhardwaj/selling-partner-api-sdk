...
beforeEach(() => {
  try {
    instance = new SellingPartnerApisForFulfillmentOutbound.ListReturnReasonCodesResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApisForFulfillmentOutbound.ListReturnReasonCodesResponse.prototype);
  }
});
...
describe('ListReturnReasonCodesResponse', () => {
  it('should create an instance of ListReturnReasonCodesResponse', () => {
    expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.ListReturnReasonCodesResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('ListReturnReasonCodesResult');
