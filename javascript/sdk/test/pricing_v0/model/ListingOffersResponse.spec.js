...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForPricing.ListingOffersResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForPricing.ListingOffersResponse.prototype);
  }
});
...
describe('ListingOffersResponse', () => {
  it('should create an instance of ListingOffersResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForPricing.ListingOffersResponse);
  });
  ...
  it('should have the property request', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('ListingOffersRequestParams');
