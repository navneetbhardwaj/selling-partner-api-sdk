...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForPricing.ListingOffersRequestParams();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForPricing.ListingOffersRequestParams.prototype);
  }
});
...
describe('ListingOffersRequestParams', () => {
  it('should create an instance of ListingOffersRequestParams', () => {
    expect(instance).to.be.a(SellingPartnerApiForPricing.ListingOffersRequestParams);
  });
