...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForPricing.GetOffersResponse.prototype);
  }
});
...
describe('GetOffersResponse', () => {
  it('should create an instance of GetOffersResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetOffersResult');
