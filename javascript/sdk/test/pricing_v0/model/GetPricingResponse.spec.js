...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForPricing.GetPricingResponse.prototype);
  }
});
...
describe('GetPricingResponse', () => {
  it('should create an instance of GetPricingResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('Price', true);
