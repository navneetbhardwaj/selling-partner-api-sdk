...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForPricing.SellerFeedbackType.prototype);
  }
});
...
describe('SellerFeedbackType', () => {
  it('should create an instance of SellerFeedbackType', () => {
    expect(instance).to.be.a(SellingPartnerApiForPricing.SellerFeedbackType);
  });

  it('should have the property sellerPositiveFeedbackRating', () => {
  ...
  it('should have the property feedbackCount', () => {
    // verify property exists
