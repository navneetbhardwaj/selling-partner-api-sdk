...
beforeEach(() => {
  try {
    ...
    instance = Object.create(TheSellingPartnerApiForTransfers.GetPaymentMethodsResponse.prototype);
  }
});
...
describe('GetPaymentMethodsResponse', () => {
  it('should create an instance of GetPaymentMethodsResponse', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForTransfers.GetPaymentMethodsResponse);
  });

  it('should have the property paymentMethods', () => {
    // verify property exists
    expect(instance).to.have.property('paymentMethods');

    // set and verify value
    const expectedValue = generateMockData('PaymentMethodDetails', true);
