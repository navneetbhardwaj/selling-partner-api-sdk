...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForServices.AppointmentTimeInput.prototype);
  }
});
...
describe('AppointmentTimeInput', () => {
  it('should create an instance of AppointmentTimeInput', () => {
  ...
  it('should have the property durationInMinutes', () => {
    // verify property exists
