...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForServices.UpdateScheduleRequest();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForServices.UpdateScheduleRequest.prototype);
  }
});
...
describe('UpdateScheduleRequest', () => {
  it('should create an instance of UpdateScheduleRequest', () => {
    expect(instance).to.be.a(SellingPartnerApiForServices.UpdateScheduleRequest);
  });

  it('should have the property schedules', () => {
    // verify property exists
    expect(instance).to.have.property('schedules');

    // set and verify value
    const expectedValue = generateMockData('AvailabilityRecord', true);
