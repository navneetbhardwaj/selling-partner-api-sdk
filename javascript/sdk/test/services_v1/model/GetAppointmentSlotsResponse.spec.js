...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForServices.GetAppointmentSlotsResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForServices.GetAppointmentSlotsResponse.prototype);
  }
});
...
describe('GetAppointmentSlotsResponse', () => {
  it('should create an instance of GetAppointmentSlotsResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForServices.GetAppointmentSlotsResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('AppointmentSlotReport');
