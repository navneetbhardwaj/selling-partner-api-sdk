...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForServices.AssignAppointmentResourcesResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForServices.AssignAppointmentResourcesResponse.prototype);
  }
});
...
describe('AssignAppointmentResourcesResponse', () => {
  it('should create an instance of AssignAppointmentResourcesResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForServices.AssignAppointmentResourcesResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('AssignAppointmentResourcesResponsePayload');
