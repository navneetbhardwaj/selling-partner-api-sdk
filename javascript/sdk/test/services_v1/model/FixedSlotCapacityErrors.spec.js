...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForServices.FixedSlotCapacityErrors();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForServices.FixedSlotCapacityErrors.prototype);
  }
});
...
describe('FixedSlotCapacityErrors', () => {
  it('should create an instance of FixedSlotCapacityErrors', () => {
    expect(instance).to.be.a(SellingPartnerApiForServices.FixedSlotCapacityErrors);
  });
