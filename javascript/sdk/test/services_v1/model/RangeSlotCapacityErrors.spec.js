...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForServices.RangeSlotCapacityErrors();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForServices.RangeSlotCapacityErrors.prototype);
  }
});
...
describe('RangeSlotCapacityErrors', () => {
  it('should create an instance of RangeSlotCapacityErrors', () => {
    expect(instance).to.be.a(SellingPartnerApiForServices.RangeSlotCapacityErrors);
  });
