...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForServices.CreateReservationResponse.prototype);
  }
});
...
describe('CreateReservationResponse', () => {
  it('should create an instance of CreateReservationResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('CreateReservationRecord');
