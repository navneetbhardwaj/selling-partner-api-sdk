...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForServices.Error();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForServices.Error.prototype);
  }
});
...
describe('Error', () => {
  it('should create an instance of Error', () => {
    expect(instance).to.be.a(SellingPartnerApiForServices.Error);
  });
  ...
  it('should have the property errorLevel', () => {
    // verify property exists
    expect(instance).to.have.property('errorLevel');

    // set and verify value
    const expectedValue = ['ERROR', 'WARNING', ][0];
    instance.errorLevel = expectedValue;
    expect(instance.errorLevel).to.equal(expectedValue);
  });
