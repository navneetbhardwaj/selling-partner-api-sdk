...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForServices.UpdateScheduleResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForServices.UpdateScheduleResponse.prototype);
  }
});
...
describe('UpdateScheduleResponse', () => {
  it('should create an instance of UpdateScheduleResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForServices.UpdateScheduleResponse);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('UpdateScheduleRecord', true);
