...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForServices.RescheduleAppointmentRequest.prototype);
  }
});
...
describe('RescheduleAppointmentRequest', () => {
  it('should create an instance of RescheduleAppointmentRequest', () => {
  ...
  it('should have the property appointmentTime', () => {
    ...
    const expectedValue = generateMockData('AppointmentTimeInput');
    instance.appointmentTime = expectedValue;
    expect(instance.appointmentTime).to.equal(expectedValue);
  });

  it('should have the property rescheduleReasonCode', () => {
    // verify property exists
