...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForServices.CreateServiceDocumentUploadDestination();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForServices.CreateServiceDocumentUploadDestination.prototype);
  }
});
...
describe('CreateServiceDocumentUploadDestination', () => {
  it('should create an instance of CreateServiceDocumentUploadDestination', () => {
    expect(instance).to.be.a(SellingPartnerApiForServices.CreateServiceDocumentUploadDestination);
  });
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('ServiceDocumentUploadDestination');
