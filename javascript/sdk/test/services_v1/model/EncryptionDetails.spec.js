...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForServices.EncryptionDetails.prototype);
  }
});
...
describe('EncryptionDetails', () => {
  it('should create an instance of EncryptionDetails', () => {
