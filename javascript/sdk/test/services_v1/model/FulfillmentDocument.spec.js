...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForServices.FulfillmentDocument.prototype);
  }
});
...
describe('FulfillmentDocument', () => {
  it('should create an instance of FulfillmentDocument', () => {
  ...
  it('should have the property contentSha256', () => {
    // verify property exists
