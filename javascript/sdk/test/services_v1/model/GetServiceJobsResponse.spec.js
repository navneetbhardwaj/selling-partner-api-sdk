...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForServices.GetServiceJobsResponse.prototype);
  }
});
...
describe('GetServiceJobsResponse', () => {
  it('should create an instance of GetServiceJobsResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('JobListing');
