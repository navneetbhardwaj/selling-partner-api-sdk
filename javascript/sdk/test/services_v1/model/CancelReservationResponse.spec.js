...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForServices.CancelReservationResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForServices.CancelReservationResponse.prototype);
  }
});
...
describe('CancelReservationResponse', () => {
  it('should create an instance of CancelReservationResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForServices.CancelReservationResponse);
  });
