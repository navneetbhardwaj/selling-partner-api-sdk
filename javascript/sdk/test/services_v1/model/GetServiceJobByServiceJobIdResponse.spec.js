...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForServices.GetServiceJobByServiceJobIdResponse.prototype);
  }
});
...
describe('GetServiceJobByServiceJobIdResponse', () => {
  it('should create an instance of GetServiceJobByServiceJobIdResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('ServiceJob');
