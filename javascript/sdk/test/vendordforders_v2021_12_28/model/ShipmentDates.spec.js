...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForDirectFulfillmentOrders.ShipmentDates.prototype);
  }
});
...
describe('ShipmentDates', () => {
  it('should create an instance of ShipmentDates', () => {
    expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.ShipmentDates);
  });

  it('should have the property requiredShipDate', () => {
