...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForDirectFulfillmentOrders.Pagination();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForDirectFulfillmentOrders.Pagination.prototype);
  }
});
...
describe('Pagination', () => {
  it('should create an instance of Pagination', () => {
    expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.Pagination);
  });
