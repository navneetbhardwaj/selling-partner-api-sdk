...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForMerchantFulfillment.Constraint.prototype);
  }
});
...
describe('Constraint', () => {
  it('should create an instance of Constraint', () => {
    expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.Constraint);
  });

  it('should have the property validationRegEx', () => {
  ...
  it('should have the property validationString', () => {
    // verify property exists
