...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForMerchantFulfillment.AdditionalInputs.prototype);
  }
});
...
describe('AdditionalInputs', () => {
  it('should create an instance of AdditionalInputs', () => {
  ...
  it('should have the property sellerInputDefinition', () => {
    // verify property exists
    expect(instance).to.have.property('sellerInputDefinition');

    // set and verify value
    const expectedValue = generateMockData('SellerInputDefinition');
