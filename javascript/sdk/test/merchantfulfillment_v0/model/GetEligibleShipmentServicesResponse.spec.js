...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForMerchantFulfillment.GetEligibleShipmentServicesResponse.prototype);
  }
});
...
describe('GetEligibleShipmentServicesResponse', () => {
  it('should create an instance of GetEligibleShipmentServicesResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetEligibleShipmentServicesResult');
