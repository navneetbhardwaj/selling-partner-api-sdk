...
describe('GetAdditionalSellerInputsResponse', () => {
  it('should create an instance of GetAdditionalSellerInputsResponse', () => {
  ...
  it('should have the property payload', () => {
    ...
    const expectedValue = generateMockData('GetAdditionalSellerInputsResult');
