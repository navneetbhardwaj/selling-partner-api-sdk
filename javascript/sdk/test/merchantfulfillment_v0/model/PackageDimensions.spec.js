...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForMerchantFulfillment.PackageDimensions.prototype);
  }
});
...
describe('PackageDimensions', () => {
  ...
  it('should have the property predefinedPackageDimensions', () => {
    // verify property exists
    expect(instance).to.have.property('predefinedPackageDimensions');

    // set and verify value
    const expectedValue = generateMockData('PredefinedPackageDimensions');
    instance.predefinedPackageDimensions = expectedValue;
    expect(instance.predefinedPackageDimensions).to.equal(expectedValue);
  });
