...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForMerchantFulfillment.GetAdditionalSellerInputsResult.prototype);
  }
});
...
describe('GetAdditionalSellerInputsResult', () => {
  it('should create an instance of GetAdditionalSellerInputsResult', () => {
    expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.GetAdditionalSellerInputsResult);
  });

  it('should have the property shipmentLevelFields', () => {
  ...
  it('should have the property itemLevelFieldsList', () => {
    // verify property exists
    expect(instance).to.have.property('itemLevelFieldsList');

    // set and verify value
    const expectedValue = generateMockData('ItemLevelFields', true);
