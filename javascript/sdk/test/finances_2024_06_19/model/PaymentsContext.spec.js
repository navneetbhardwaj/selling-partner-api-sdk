...
beforeEach(() => {
  try {
    ...
    instance = Object.create(TheSellingPartnerApiForFinances.PaymentsContext.prototype);
  }
});
...
describe('PaymentsContext', () => {
  it('should create an instance of PaymentsContext', () => {
