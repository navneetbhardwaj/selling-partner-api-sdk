...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForSolicitations.GetSolicitationActionResponse.prototype);
  }
});
...
describe('GetSolicitationActionResponse', () => {
  it('should create an instance of GetSolicitationActionResponse', () => {
  ...
  it('should have the property links', () => {
    ...
    const expectedValue = generateMockData('GetSolicitationActionResponseLinks');
    instance.links = expectedValue;
    expect(instance.links).to.equal(expectedValue);
  });

  it('should have the property embedded', () => {
    // verify property exists
    expect(instance).to.have.property('embedded');

    // set and verify value
    const expectedValue = generateMockData('GetSolicitationActionResponseEmbedded');
  ...
  it('should have the property payload', () => {
    ...
    // set and verify value
    const expectedValue = generateMockData('SolicitationsAction');
