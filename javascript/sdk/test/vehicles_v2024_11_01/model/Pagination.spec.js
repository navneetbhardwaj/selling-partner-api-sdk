...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForAutomotive.Pagination();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForAutomotive.Pagination.prototype);
  }
});
...
describe('Pagination', () => {
  it('should create an instance of Pagination', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForAutomotive.Pagination);
  });
  ...
  it('should have the property previousToken', () => {
    // verify property exists
