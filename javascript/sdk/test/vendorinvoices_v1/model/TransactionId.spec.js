...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForRetailProcurementPayments.TransactionId();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForRetailProcurementPayments.TransactionId.prototype);
  }
});
...
describe('TransactionId', () => {
  it('should create an instance of TransactionId', () => {
    expect(instance).to.be.a(SellingPartnerApiForRetailProcurementPayments.TransactionId);
  });
