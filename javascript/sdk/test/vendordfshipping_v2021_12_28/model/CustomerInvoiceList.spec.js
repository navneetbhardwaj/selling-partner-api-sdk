...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForDirectFulfillmentShipping.CustomerInvoiceList.prototype);
  }
});
...
describe('CustomerInvoiceList', () => {
  it('should create an instance of CustomerInvoiceList', () => {
  ...
  it('should have the property customerInvoices', () => {
    // verify property exists
    expect(instance).to.have.property('customerInvoices');

    // set and verify value
    const expectedValue = generateMockData('CustomerInvoice', true);
