...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForDirectFulfillmentShipping.SubmitShipmentStatusUpdatesRequest.prototype);
  }
});
...
describe('SubmitShipmentStatusUpdatesRequest', () => {
  it('should create an instance of SubmitShipmentStatusUpdatesRequest', () => {
    expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentShipping.SubmitShipmentStatusUpdatesRequest);
  });

  it('should have the property shipmentStatusUpdates', () => {
    // verify property exists
    expect(instance).to.have.property('shipmentStatusUpdates');

    // set and verify value
    const expectedValue = generateMockData('ShipmentStatusUpdate', true);
