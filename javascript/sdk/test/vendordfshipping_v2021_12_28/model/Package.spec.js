...
beforeEach(() => {
  try {
    instance = new SellingPartnerApiForDirectFulfillmentShipping.Package();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(SellingPartnerApiForDirectFulfillmentShipping.Package.prototype);
  }
});
...
describe('Package', () => {
  ...
  it('should have the property packageTrackingNumber', () => {
