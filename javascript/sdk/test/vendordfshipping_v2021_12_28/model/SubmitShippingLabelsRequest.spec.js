...
beforeEach(() => {
  try {
    ...
    instance = Object.create(SellingPartnerApiForDirectFulfillmentShipping.SubmitShippingLabelsRequest.prototype);
  }
});
...
describe('SubmitShippingLabelsRequest', () => {
  it('should create an instance of SubmitShippingLabelsRequest', () => {
    expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentShipping.SubmitShippingLabelsRequest);
  });

  it('should have the property shippingLabelRequests', () => {
    // verify property exists
    expect(instance).to.have.property('shippingLabelRequests');

    // set and verify value
    const expectedValue = generateMockData('ShippingLabelRequest', true);
