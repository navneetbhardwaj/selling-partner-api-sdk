...
describe('CreateContainerLabelResponse', () => {
  it('should create an instance of CreateContainerLabelResponse', () => {
    expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentShipping.CreateContainerLabelResponse);
  });

  it('should have the property containerLabel', () => {
    // verify property exists
    expect(instance).to.have.property('containerLabel');

    // set and verify value
    const expectedValue = generateMockData('ContainerLabel');
