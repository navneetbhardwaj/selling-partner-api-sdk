...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForInvoices.GetInvoiceResponse();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForInvoices.GetInvoiceResponse.prototype);
  }
});
...
describe('GetInvoiceResponse', () => {
  it('should create an instance of GetInvoiceResponse', () => {
  ...
  it('should have the property invoice', () => {
    ...
    const expectedValue = generateMockData('Invoice');
