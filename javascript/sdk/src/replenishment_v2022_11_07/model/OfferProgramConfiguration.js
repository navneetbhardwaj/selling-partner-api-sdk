  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('preferences'))
        obj.preferences = OfferProgramConfigurationPreferences.constructFromObject(data['preferences']);
      if (data.hasOwnProperty('promotions'))
        obj.promotions = OfferProgramConfigurationPromotions.constructFromObject(data['promotions']);
      if (data.hasOwnProperty('enrollmentMethod'))
        obj.enrollmentMethod = EnrollmentMethod.constructFromObject(data['enrollmentMethod']);
    }
    return obj;
  }
}
