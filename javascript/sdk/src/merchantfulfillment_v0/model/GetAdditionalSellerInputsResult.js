  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ShipmentLevelFields'))
        obj.shipmentLevelFields = ApiClient.convertToType(data['ShipmentLevelFields'], [AdditionalInputs]);
      if (data.hasOwnProperty('ItemLevelFieldsList'))
        obj.itemLevelFieldsList = ApiClient.convertToType(data['ItemLevelFieldsList'], [ItemLevelFields]);
    }
    return obj;
  }
}
