  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('SKUPrepInstructionsList'))
        obj.sKUPrepInstructionsList = ApiClient.convertToType(data['SKUPrepInstructionsList'], [SKUPrepInstructions]);
      if (data.hasOwnProperty('InvalidSKUList'))
        obj.invalidSKUList = ApiClient.convertToType(data['InvalidSKUList'], [InvalidSKU]);
      if (data.hasOwnProperty('ASINPrepInstructionsList'))
        obj.aSINPrepInstructionsList = ApiClient.convertToType(data['ASINPrepInstructionsList'], [ASINPrepInstructions]);
      if (data.hasOwnProperty('InvalidASINList'))
        obj.invalidASINList = ApiClient.convertToType(data['InvalidASINList'], [InvalidASIN]);
    }
    return obj;
  }
}
