  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('FundTransferDate'))
        obj.fundTransferDate = ApiClient.convertToType(data['FundTransferDate'], 'Date');
      ...
      if (data.hasOwnProperty('FinancialEventGroupStart'))
        obj.financialEventGroupStart = ApiClient.convertToType(data['FinancialEventGroupStart'], 'Date');
      if (data.hasOwnProperty('FinancialEventGroupEnd'))
        obj.financialEventGroupEnd = ApiClient.convertToType(data['FinancialEventGroupEnd'], 'Date');
    }
    return obj;
  }
}
