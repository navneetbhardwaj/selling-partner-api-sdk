  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('OrderChargeList'))
        obj.orderChargeList = ApiClient.convertToType(data['OrderChargeList'], [ChargeComponent]);
      if (data.hasOwnProperty('OrderChargeAdjustmentList'))
        obj.orderChargeAdjustmentList = ApiClient.convertToType(data['OrderChargeAdjustmentList'], [ChargeComponent]);
      if (data.hasOwnProperty('ShipmentFeeList'))
        obj.shipmentFeeList = ApiClient.convertToType(data['ShipmentFeeList'], [FeeComponent]);
      if (data.hasOwnProperty('ShipmentFeeAdjustmentList'))
        obj.shipmentFeeAdjustmentList = ApiClient.convertToType(data['ShipmentFeeAdjustmentList'], [FeeComponent]);
      if (data.hasOwnProperty('OrderFeeList'))
        obj.orderFeeList = ApiClient.convertToType(data['OrderFeeList'], [FeeComponent]);
      if (data.hasOwnProperty('OrderFeeAdjustmentList'))
        obj.orderFeeAdjustmentList = ApiClient.convertToType(data['OrderFeeAdjustmentList'], [FeeComponent]);
      if (data.hasOwnProperty('DirectPaymentList'))
        obj.directPaymentList = ApiClient.convertToType(data['DirectPaymentList'], [DirectPayment]);
      ...
      if (data.hasOwnProperty('ShipmentItemList'))
        obj.shipmentItemList = ApiClient.convertToType(data['ShipmentItemList'], [ShipmentItem]);
      if (data.hasOwnProperty('ShipmentItemAdjustmentList'))
        obj.shipmentItemAdjustmentList = ApiClient.convertToType(data['ShipmentItemAdjustmentList'], [ShipmentItem]);
    }
    return obj;
  }
}
