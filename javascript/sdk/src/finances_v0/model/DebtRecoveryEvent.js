  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('DebtRecoveryItemList'))
        obj.debtRecoveryItemList = ApiClient.convertToType(data['DebtRecoveryItemList'], [DebtRecoveryItem]);
      if (data.hasOwnProperty('ChargeInstrumentList'))
        obj.chargeInstrumentList = ApiClient.convertToType(data['ChargeInstrumentList'], [ChargeInstrument]);
    }
    return obj;
  }
}
