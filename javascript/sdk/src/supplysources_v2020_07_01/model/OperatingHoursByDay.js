  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('monday'))
        obj.monday = ApiClient.convertToType(data['monday'], [OperatingHour]);
      if (data.hasOwnProperty('tuesday'))
        obj.tuesday = ApiClient.convertToType(data['tuesday'], [OperatingHour]);
      if (data.hasOwnProperty('wednesday'))
        obj.wednesday = ApiClient.convertToType(data['wednesday'], [OperatingHour]);
      if (data.hasOwnProperty('thursday'))
        obj.thursday = ApiClient.convertToType(data['thursday'], [OperatingHour]);
      if (data.hasOwnProperty('friday'))
        obj.friday = ApiClient.convertToType(data['friday'], [OperatingHour]);
      if (data.hasOwnProperty('saturday'))
        obj.saturday = ApiClient.convertToType(data['saturday'], [OperatingHour]);
      if (data.hasOwnProperty('sunday'))
        obj.sunday = ApiClient.convertToType(data['sunday'], [OperatingHour]);
    }
    return obj;
  }
}
