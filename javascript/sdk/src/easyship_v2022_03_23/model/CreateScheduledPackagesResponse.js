  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('scheduledPackages'))
        obj.scheduledPackages = ApiClient.convertToType(data['scheduledPackages'], [Package]);
      ...
      if (data.hasOwnProperty('printableDocumentsUrl'))
        obj.printableDocumentsUrl = ApiClient.convertToType(data['printableDocumentsUrl'], 'String');
    }
    return obj;
  }
}
