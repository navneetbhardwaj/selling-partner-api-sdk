  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('earliestShipDate'))
        obj.earliestShipDate = ApiClient.convertToType(data['earliestShipDate'], 'Date');
      if (data.hasOwnProperty('latestShipDate'))
        obj.latestShipDate = ApiClient.convertToType(data['latestShipDate'], 'Date');
      if (data.hasOwnProperty('earliestArrivalDate'))
        obj.earliestArrivalDate = ApiClient.convertToType(data['earliestArrivalDate'], 'Date');
      if (data.hasOwnProperty('latestArrivalDate'))
        obj.latestArrivalDate = ApiClient.convertToType(data['latestArrivalDate'], 'Date');
      ...
      if (data.hasOwnProperty('fulfillmentPreviewItems'))
        obj.fulfillmentPreviewItems = ApiClient.convertToType(data['fulfillmentPreviewItems'], [FulfillmentPreviewItem]);
    }
    return obj;
  }
}
