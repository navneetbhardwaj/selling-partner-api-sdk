  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items'))
        obj.items = ApiClient.convertToType(data['items'], [GetFulfillmentPreviewItem]);
      if (data.hasOwnProperty('shippingSpeedCategories'))
        obj.shippingSpeedCategories = ApiClient.convertToType(data['shippingSpeedCategories'], [ShippingSpeedCategory]);
