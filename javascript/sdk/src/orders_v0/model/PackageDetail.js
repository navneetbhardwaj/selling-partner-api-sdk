  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('packageReferenceId'))
        obj.packageReferenceId = ApiClient.convertToType(data['packageReferenceId'], 'String');
      ...
      if (data.hasOwnProperty('orderItems'))
        obj.orderItems = ApiClient.convertToType(data['orderItems'], [ConfirmShipmentOrderItem]);
    }
    return obj;
  }
}
